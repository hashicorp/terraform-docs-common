...
description: >-
  The plugin framework is an SDK for Terraform provider development that you can
  use to develop your own Terraform providers. Learn about the benefits of the
  provider Framework over SDKv2.
---
