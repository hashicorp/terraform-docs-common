...
- Try these hands-on tutorials: [Implement a Provider with the Terraform Plugin Framework](/terraform/tutorials/providers-plugin-framework) and [Call APIs with Custom SDK Providers](/terraform/tutorials/providers) 
