...
- Try these hands-on tutorials: [Call APIs with Terraform Providers (SDKv2)](/terraform/tutorials/providers) and [Implement a Provider with the Terraform Plugin Framework](/terraform/tutorials/providers-plugin-framework)
