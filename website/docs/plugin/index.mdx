...
- Try these hands-on tutorials: [Implement a Provider with the Terraform Plugin Framework](/terraform/tutorials/providers-plugin-framework) and [Call APIs with Terraform Providers (SDKv2)](/terraform/tutorials/providers) 
...
- Learn more about **how to use [SDKv2](/plugin/sdkv2)** to develop providers. This includes details about how to define attributes and behaviors using [schemas](/plugin/sdkv2/schemas), [develop resources](/plugin/sdkv2/resources), [debug providers](/plugin/sdkv2/debugging), and [test plugins](/plugin/sdkv2/testing).
