...
Refer to the [Terraform CLI Configuration File documentation](/terraform/cli/config/config-file#development-overrides-for-provider-developers) for additional information about the configuration file and the developement overrides functionality.
