...
![Code Generation - High Level Overview](/img/docs/tfcodegen-overview.png)
...
![Code Generation - Expanded Overview](/img/docs/tfcodegen-expanded-overview.png)
...
You can read more details in the [Specification](/terraform/plugin/code-generation/specification) section.
...
![Code Generation - OpenAPI Overview](/img/docs/tfcodegen-openapi-overview.png)

For this example, you can read more about each tool in it's linked section below:
...
![Provider Development - Manual developer workflow](/img/docs/tfcodegen-manual-dev.png)
...
![Provider Development - Manual developer workflow with API spec](/img/docs/tfcodegen-manual-dev-w-spec.png)
