...
Terraform opens a browser to the [HCP Terraform](https://app.terraform.io/) sign in screen. Enter a token name in the web UI, or leave the default name. Click **Create API token** to generate the authentication token.
