...
| ------ | ----------- | ------- | -------- |
| `-config` | Specifies the path to an optional configuration file. Refer to  [Terraform migrate configuration file reference](/terraform/cloud-docs/migrate/tf-migrate/reference/configuration) for more information. | None | No |
