...
description: >-
    Use an HCP organization or a linked HCP Terraform account to activate pay-as-you-go HCP billing to upgrade to the standard or plus editions of HCP Terraform.
tfc_only: true
---
