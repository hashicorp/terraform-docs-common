...
To enable pay-as-you-go and change your organization's plan, sign in to [HCP Terraform](https://app.terraform.io/) and navigate to **Organization Settings > Plan & Billing**. 
