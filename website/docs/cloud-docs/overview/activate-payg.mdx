...
To enable pay-as-you-go and change your organization's plan, sign in to [HCP Terraform](https://app.terraform.io/), select your organization, and navigate to **Settings > Plan & Billing**. 
