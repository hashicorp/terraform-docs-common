...
1. You must create a HashiCorp Cloud Platform (HCP) organization to allocate the HashiCorp Flex balance to.
1. You must share the HCP organization ID with the HashiCorp sales team. 
...
Navigate to the **HCP Org > Billing**.  If HashiCorp Flex is allocated, the page displays a **Contract Summary** with an available balance. If it only shows your credit card information or a $50 free trial credit, your HashiCorp Flex account may be scheduled to be allocated at a future date. Please contact your **HashiCorp Sales Account Manager** for more information.
...
~> **Note**: If you have a unified HCP account, you do not need to log in and Terraform Cloud will automatically identify qualified HCP organizations that your unified HCP user account is a member of.
