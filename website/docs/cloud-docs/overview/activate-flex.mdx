---
page_title: Activate HashiCorp Flex - Plans and Features - HCP Terraform
description: >-
   Estimate and manage your costs on HCP Terraform 
...
1. Email your HashiCorp sales account manager with your HCP organization ID.
1. You must be a member of your HCP Terraform organization's "owners" team.
...
You can self-activate your Flex plan by completing the following steps:
1. Copy the HCP Flex activation code from your email.
1. Click the link in your activation email to access your HCP organization or log in to your HCP portal. Then, navigate to **Billing > Payment Methods** and find the **Contract** section.
1. Add the activation code you copied to the **Contract** section.
