...
For an HCP Organization not already on Flex, you must self-activate your Flex contract to transition your HCP Organization to Flex.
The technical contact your organization provided to your sales account manager will receive a Flex contract activation email.
Please follow the [Flex contract activation documentation](/hcp/docs/hcp/admin/billing/flex-multiyear#activate-your-contract)
