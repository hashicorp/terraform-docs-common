...
Organization members may be owners or admins in only the Terraform Cloud or HCP organization. To safeguard access to your Flex balance, determine whether to invite Terraform Cloud organization owners to the HCP organization, or whether to invite HCP admins to Terraform Cloud. Consider the following as examples to decide which approach is right for your organization.

- The HCP admin offers Terraform Cloud as a multi-tenant managed service. They manage the billing relationship with HashiCorp Cloud Platform and services customers of Terraform Cloud.  The HCP admin should be invited to the Terraform Cloud customer organizations to activate Flex.
- The HCP admin manages the billing relationship with HashiCorp Cloud Platform and owns all the Terraform Cloud organizations. They can use either approach and invite HCP admins to Terraform Cloud organizations or make Terraform Cloud organization owners into HCP admins.
