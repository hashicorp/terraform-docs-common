...
HCP Terraform disables cost estimation by default. You can enable or disable cost estimation by doing the following:
...
1. Click **Settings**, then click **Cost Estimation**.
1. Toggle the **Enable cost estimation for all workspaces
** setting.
