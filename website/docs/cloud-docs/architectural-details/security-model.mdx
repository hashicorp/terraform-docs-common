...
Terraform Cloud Agents can be shared across all workspaces within an organzation, or scoped to specific workspaces. We recommend creating seperate agent pools for sensitive workspaces, to prevent malicious cross-workspace data access via agents.
