---
page_title: Security model for HCP Terraform
description: >-
  Learn about HCP Terraform's security and authorization model to identify potential security threats and follow our recommendations to securely use HCP Terraform.
tfc_only: true
---
