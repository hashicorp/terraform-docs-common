...
Each workspace belongs to a project. Refer to [Manage project](/terraform/cloud-docs/projects/manage) for additional information.
...
You can define key-value pairs to help you organize your workspaces and track resource consumption. You can define tags while [creating the workspace](#create-a-workspace) or create and attach them to an existing workspace.
