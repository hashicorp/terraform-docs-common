...
-> **Note:** Projects are available to all users, but managing project permissions requires the [Standard](https://www.hashicorp.com/products/terraform/pricing) edition.
