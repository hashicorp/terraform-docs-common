...
- To configure variables, enter a value or click **Ignore variable** for each variable on the page. You may want to ignore a variable if you know you will provide it through another source, like an `auto.tfvars` file. Click **Save variables** to add these variables to the workspace.
