---
page_title: Creating Workspaces - Workspaces - HCP Terraform
description: >-
...
1. Add an optional **Description** that will appear at the top of the workspace in the HCP Terraform UI.
