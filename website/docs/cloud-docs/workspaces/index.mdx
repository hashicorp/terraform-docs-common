...
- Continuous validation checks whether custom conditions in the workspace’s configuration continue to pass after Terraform has provisioned the infrastructure.
