...
-> **Note:**  The explorer for workspace visibility surfaces a wider range of valuable information from across your workspaces. [Learn more](/terraform/cloud-docs/workspaces/explorer).
...
Projects let you organize your workspaces into groups. Organizations with the [Standard](https://www.hashicorp.com/products/terraform/pricing) edition can assign project permissions to scope access to collections of workspaces based on business units and responsibilities.
