...
description: >-
  Learn how to generate workload identity tokens to allow Terraform runs to safely authenticate with custom workflows or providers that do not natively support dynamic credentials.
---
