---
page_title: Manually Generating Workload Identity Tokens - Workspaces - HCP Terraform
description: >-
  Manually generating workload identity tokens for use in your HCP Terraform runs.
---
