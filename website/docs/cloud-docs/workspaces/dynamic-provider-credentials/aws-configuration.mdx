...
| `TFC_AWS_RUN_ROLE_ARN`  | The ARN of the role to assume in AWS. | Requires **v1.7.0** or later if self-managing agents. Optional if `TFC_AWS_PLAN_ROLE_ARN` and `TFC_AWS_APPLY_ROLE_ARN` are both provided. These variables are described [below](/terraform/cloud-docs/workspaces/dynamic-provider-credentials/aws-configuration#optional-environment-variables) |
...
### Required Environment Variables for multiple alias providers
| Variable                | Value                                 | Notes                                                                                                                                                                                                                                                                                           |
|-------------------------|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `TFC_AWS_PROVIDER_AUTH` | `true`                                | Requires **v1.7.0** or later if self-managing agents. Must be present and set to `true`, or Terraform Cloud will not attempt to authenticate to AWS.                                                                                                                                            |
| `TFC_AWS_RUN_ROLE_ARN`  | The ARN of the role to assume in AWS default provider. | Requires **v1.7.0** or later if self-managing agents. Optional if `TFC_AWS_PLAN_ROLE_ARN` and `TFC_AWS_APPLY_ROLE_ARN` are both provided. These variables are described [below](/terraform/cloud-docs/workspaces/dynamic-provider-credentials/aws-configuration#optional-environment-variables) |
| `TFC_AWS_PROVIDER_AUTH_ALIAS1` | `true`                                | Requires **v1.7.0** or later if self-managing agents. Must be present and set to `true`, or Terraform Cloud will not attempt to authenticate to AWS.                                                                                                                                            |
| `TFC_AWS_RUN_ROLE_ARN_ALIAS1`  | The ARN of the role to assume in AWS alias provider. | Requires **v1.7.0** or later if self-managing agents. Optional if `TFC_AWS_PLAN_ROLE_ARN` and `TFC_AWS_APPLY_ROLE_ARN` are both provided. These variables are described [below](/terraform/cloud-docs/workspaces/dynamic-provider-credentials/aws-configuration#optional-environment-variables) |
