...
### Configure the AzureRM or Azure Entra ID
...
~> **Important:** Ensure you are using version **3.60.0** or later of the **AzureRM provider** and version **2.43.0** or later of the **Azure Entra ID provider** (previously AzureAD) as required functionality was introduced in these provider versions.
...
##### Azure Entra ID Provider (previously AzureAD)
