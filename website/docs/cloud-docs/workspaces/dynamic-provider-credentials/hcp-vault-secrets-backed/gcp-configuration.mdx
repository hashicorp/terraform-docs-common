...
| `TFC_HVS_BACKED_GCP_RUN_SECRET_RESOURCE_NAME`                                                           | The name of the HCP Vault Secrets dynamic secret resource to read.                    | Requires **v1.8.0** or later if self-managing agents. Must be present.                                                                                 |
...
| `TFC_HVS_BACKED_GCP_PLAN_SECRET_RESOURCE_NAME`                                                                              | The name of the HCP Vault Secrets dynamic secret resource to read for the plan phase.                                                                                                                        | Requires **v1.8.0** or later if self-managing agents. Must be present.                                                                      |
| `TFC_HVS_BACKED_GCP_APPLY_SECRET_RESOURCE_NAME`                                                                             | The name of the HCP Vault Secrets dynamic secret resource to read for the apply phase.                                                                                                                       | Requires **v1.8.0** or later if self-managing agents. Must be present.                                                                      |
