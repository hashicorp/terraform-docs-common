...
- [Drift detection](#drift-detection): Terraform Cloud determines whether your real-world infrastructure matches your Terraform state file.
- [Continuous validation](#continuous-validation): Terraform Cloud determines whether custom conditions in the workspace’s configuration continue to pass after Terraform provisions the infrastructure.
