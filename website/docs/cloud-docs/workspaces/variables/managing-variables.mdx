...
Only members of the [Owners Team](/cloud-docs/users-teams-organizations/permissions#organization-owners) or members of a team with the [Manage all projects & workspaces](/cloud-docs/users-teams-organizations/permissions#manage-all-projects-workspaces) or [Manage workspaces only](/cloud-docs/users-teams-organizations/permissions#manage-workspaces-only) permission can create, update, and delete variable sets.
