...
For organization-owned variable sets, only members of the [Owners Team](/terraform/cloud-docs/users-teams-organizations/permissions#organization-owners) or members of a team with either [**Manage all projects**](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-projects) or [**Manage all workspaces**](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-workspaces) permissions can create, update, and delete variable sets.

For project-owned variable sets, members of a team with Write, Maintain, or Admin access to the project or the [**Manage all projects**](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-projects) permission can create, update, and delete variable sets. You can only apply project-owned variable sets to workspaces within the project.
