...
1. Choose a variable set scope:
   ...
   - **Apply to specific projects and workspaces:** Use the text fields to search for and select workspaces and/or projects to apply this variable set to. Users can also [add this variable set to their workspaces](#apply-or-remove-variable-sets-from-inside-a-workspace) after creation.
