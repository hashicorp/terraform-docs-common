...
Only members of the [Owners Team](/terraform/cloud-docs/users-teams-organizations/permissions#organization-owners) or members of a team with the [Manage all projects & workspaces](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-projects-workspaces) or [Manage workspaces only](/terraform/cloud-docs/users-teams-organizations/permissions#manage-workspaces-only) permission can create, update, and delete variable sets.
...
1. Choose a variable set scope:
   ...
   - **Apply to specific projects and workspaces:** Use the text fields to search for and select workspaces and/or projects to apply this variable set to. All current and future workspaces in any selected projects will access this variable set. Users can also [add this variable set to their workspaces](#apply-or-remove-variable-sets-from-inside-a-workspace) after creation.
