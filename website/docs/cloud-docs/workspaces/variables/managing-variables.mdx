...
1. Sign in to [HCP Terraform](https://app.terraform.io/) and select the workspace you want to add a variable to.
...
1. Sign in to [HCP Terraform](https://app.terraform.io/) and navigate to the **Settings** page for your organization or project.
