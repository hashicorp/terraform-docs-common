...
Variable set ownership determines whether the variable set is managed at the organization level or the project level.

Use organization-owned variable sets to share variables across multiple projects. Because they can be applied to workspaces in any project in the organization, managing organization-owned variable sets requires a higher level of permissions.

Use project-owned variable sets to share variables across multiple workspaces within a single project. Project-owned variable sets allow for more localized management because they require permissions on the project rather than on the entire organization.

See the section on [**mangaging variable sets**](/terraform/cloud-docs/workspaces/variables/managing-variables#variable-sets) for more details on the different permissions required.
...
### 3. Priority project-scoped variable set owned by an project
...
### 4. Priority workspace-scoped variable set owned by an organization
...
### 5. Priority workspace-scoped variable set owned by an project
...
### 10. Workspace-scoped variable set owned by an organization
...
### 11. Project-scoped variable set owned by a project
...
### 11.  Project-scoped variable set owned by an organization
