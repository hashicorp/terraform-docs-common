---
page_title: Workspace Variables
description: >-
  HCP Terraform workspace variables that you can use to customize Terraform runs. Learn how to use Terraform variables and environment variables.
---
