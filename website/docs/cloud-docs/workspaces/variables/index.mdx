...
Refer to [**Managing variable sets**](/terraform/cloud-docs/workspaces/variables/managing-variables#variable-sets) for more details on variable set permissions.
