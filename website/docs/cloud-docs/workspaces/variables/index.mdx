...
### 2. Priority project-scoped, organization-owned variable sets

If [prioritized](/terraform/cloud-docs/workspaces/variables#precedence-with-priority-variable-sets), variables in a priority project-scoped variable set have precedence over variables with the same key set at a more specific scope. Prioritized variables sets owned by organizations take precedence over those owned by projects.


### 3. Priority project-scoped, project-owned variable sets
...
### 4. Priority workspace-scoped, organization-owned variable sets

If [prioritized](/terraform/cloud-docs/workspaces/variables#precedence-with-priority-variable-sets), variables in a priority workspace-scoped variable set have precedence over variables with the same key set at a more specific scope. Prioritized variables sets owned by organizations take precedence over those owned by projects.


### 5. Priority workspace-scoped, project-owned variable sets
...
### 9. Workspace-scoped, project-owned variable sets
...
### 10. Workspace-scoped, organization-owned variable sets
...
### 11. Project-scoped, project-owned variable sets
...
### 12. Project-scoped, organization-owned variable sets
...
| Priority **project-scoped** organization-owned variable set   | `us-east-2` |      |          |
| Priority **project-scoped** project-owned variable set        | `eu-east-2` |      |          |
| Priority **workspace-scoped** organization-owned variable set | `us-west-1` |      |          |
| Priority **workspace-scoped** project-owned variable set      | `eu-west-1` |      |          |
| Command line argument                                         | `us-west-2` |      | `9`      |
| Local environment variable                                    |             |      | `8`      |
| **Workspace-specific** variable                               |             | `h`  | `1`      |
| **Workspace-scoped** project-owned variable set               |             | `y`  | `2`      |
| **Workspace-scoped** organization-owned variable set          |             | `z`  | `3`      |
| **Project-scoped** project-owned variable set                 |             |      | `4`      |
| **Project-scoped** organization-owned variable set            |             |      | `5`      |
