---
page_title: Use SSH Keys for cloning modules in HCP Terraform
description: >-
  Learn how to configure the SSH keys that Terraform uses to pull modules from private Git repositories. Add and delete keys, and assign keys to workspaces.
---
