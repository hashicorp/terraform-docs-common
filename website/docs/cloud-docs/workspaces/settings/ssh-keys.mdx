...
1. Sign in to [HCP Terraform](https://app.terraform.io/) and choose the organization you want to add a key to.
1. Click **Settings**, then choose **SSH Keys**. This page has a form for adding new keys and a list of existing keys.
...
To delete a key:
1. Sign in to [HCP Terraform](https://app.terraform.io/) and choose the organization you want to delete a key from.
1. Click **Settings**, then choose **SSH Keys**.
