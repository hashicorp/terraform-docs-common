...
1. Choose **Settings** from the sidebar, then choose **SSH Keys**. This page has a form for adding new keys and a list of existing keys.
...
1. Choose **Settings** from the sidebar, then choose **SSH Keys**.
