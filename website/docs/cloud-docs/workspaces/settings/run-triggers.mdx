...
~> **Important:** Runs initiated in your workspace as the result of a run trigger connection to a source workspace may auto-apply depending on your [auto-apply-run-trigger](/terraform/cloud-docs/workspaces/settings#run-triggers) setting selection.
