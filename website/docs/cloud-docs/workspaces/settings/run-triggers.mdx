...
Runs initiated by run trigger will not auto-apply unless the "Auto-apply run triggers" setting is enabled. This setting operates independently of the primary workspace [auto-apply](/terraform/cloud-docs/workspaces/settings#auto-apply) setting.
