...
The source workspace includes a message in the [plan](/docs/glossary#plan-noun-1-) and [apply](/docs/glossary#apply-noun-) and apply run details that specifies the workspaces where Terraform Cloud automatically starts a run. 
