...
1. Sign in to [HCP Terraform](https://app.terraform.io/) or Terraform Enterprise, and click **Workspaces**.

1. Select to the workspace where you want to associate run tasks.
...
1. Sign in to [HCP Terraform](https://app.terraform.io/) or Terraform Enterprise, click **Settings**, and then click **Run Tasks**.
