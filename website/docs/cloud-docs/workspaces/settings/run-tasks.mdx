...
While creating a new run task you may also configure whether the new task will be applied to all workspaces in the organization. This feature requires the **global-run-task** [entitlement][].
