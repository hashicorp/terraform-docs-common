...
1. Sign in to [HCP Terraform](https://app.terraform.io/) and navigate to the workspace where you want to create a run task.
...
1. Sign in to [HCP Terraform](https://app.terraform.io/), and click **Workspaces**.
