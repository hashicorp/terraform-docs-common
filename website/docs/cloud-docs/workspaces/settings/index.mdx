...
> **Hands-on:** Try the [Upgrade Terraform Version in Terraform Cloud](https://learn.hashicorp.com/tutorials/terraform/cloud-versions) tutorial on HashiCorp Learn.
