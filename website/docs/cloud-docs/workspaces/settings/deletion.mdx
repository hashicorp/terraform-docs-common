...
The workspace policy always overrides the organization policy, and there are three types of data retention policies that a workspace admin has the ability to set or override: the organization default policy, do not auto-delete, and auto-delete data.

If the organization default policy is selected, all other selections will be disabled by default until the organization default policy checkbox is unchecked.
