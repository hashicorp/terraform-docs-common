...
When enabled, Terraform Cloud automatically runs a health assessment for your workspace every 24 hours. The assessment checks the actual settings of your infrastructure against those tracked in your workspace's state file.
