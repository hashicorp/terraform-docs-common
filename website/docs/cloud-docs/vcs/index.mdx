...
- [Azure DevOps Services (OAuth)](/terraform/cloud-docs/vcs/azure-devops-services)
- [Azure DevOps Services (PAT)](/terraform/cloud-docs/vcs/azure-devops-services-pat)
