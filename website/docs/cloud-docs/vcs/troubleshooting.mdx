...
~> **Important:** Reauthorizing is incompatible for OAuth Clients managed by the [TFE Provider](https://registry.terraform.io/providers/hashicorp/tfe/latest/docs/resources/oauth_client).
