...
tfc_only: true
description: >-
  Learn how to use GitHub.com repositories with Terraform Cloud workspaces and private registry modules, without requiring an organization owner to configure an OAuth connection.
---

[private module registry]: /cloud-docs/registry

[policy sets]: /cloud-docs/policy-enforcement/manage-policy-sets
...
These instructions are for using repositories from GitHub.com with Terraform Cloud workspaces and private registry modules, without requiring an organization owner to configure an OAuth connection.
...
You can use the Terraform Cloud GitHub App to create workspaces and private registry modules from the Terraform Cloud UI. It currently does not support:
