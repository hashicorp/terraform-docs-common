...
-> **Note:** This VCS Provider is only available on Terraform Cloud. If you are using Terraform Enterprise, you can follow the instructions for creating [GitHub App for TFE](/enterprise/admin/application/github-app-integration) or connecting to [GitHub.com via OAuth](/cloud-docs/vcs/github).
