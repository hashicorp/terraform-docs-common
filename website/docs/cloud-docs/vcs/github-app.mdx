...
You can use the Terraform Cloud GitHub App to create workspaces and private registry modules from the Terraform Cloud UI, the API or the tfe Terraform provider. These features are only supported in the following releases:
