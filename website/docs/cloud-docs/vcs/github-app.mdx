...
Access to new organizations can be granted when creating a new workspace:
1. Open the **Workspaces** view via the sidebar. 
1. Click **New** and then select **Workspace**.
1. Select the project you wish to create a new workspace in and click **Create**.
1. Click **Version Control Workflow** and then GitHub App.
1. Click GitHub Organization name right above the repository list on the left, and then **Add another organization** in order to trigger the workflow.
