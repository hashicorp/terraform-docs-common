...
The Terraform Cloud GitHub App is designed for creating workspaces and private registry modules from the Terraform Cloud UI. It currently does not support:
