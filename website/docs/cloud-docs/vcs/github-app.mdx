...
- TFE v202303-1 and later.
- [go_tfe](https://github.com/hashicorp/go-tfe) version 1.19.0 and later.
- [tfe_provider](https://registry.terraform.io/providers/hashicorp/tfe/latest/docs) version v0.43.0 and later.
