...
**As from Terraform Enterprise v202309-1 we recommend customers to be on at least v8.0 of Bitbucket server/data Center as versions prior to this may fail due to an openSSH compatibility issue, refer to [Atlassian documentation](https://jira.atlassian.com/browse/BSERV-13013?src=confmacro) for more details.
