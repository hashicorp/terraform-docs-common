...
-> **Bitbucket Server Deprecation Notice:** On February 15, 2024, Atlassian [ended support for Bitbucket Server](https://bitbucket.org/blog/cloud-migration-benefits), and are advising Bitbucket Server users to migrate to either Bitbucket Data Center or Bitbucket Cloud. As a result of this change, Bitbucket Data Center has been added as an officially supported VCS provider within TFC and TFE, and Bitbucket Server will be removed from TFC on August 15, 2024, and from TFE in the the v202410 release. If you have any questions regarding this change, please reach out to our [support team](https://support.hashicorp.com/hc/en-us).
