...
description: >-
  Learn how to use Bitbucket Server and Data Center for VCS features.
---
...
1. Select **Bitbucket** and then select **Bitbucket Server** from the menu. The page moves to the next step.
...
1. Click the "Allow" button. This returns you to Terraform Cloud to configure Advanced Settings.

## Step 3: On Terraform Cloud, Configure VCS Provider Scope (Optional)
