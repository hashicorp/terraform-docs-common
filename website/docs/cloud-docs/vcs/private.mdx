...
You can use HCP Terraform agents to connect HCP Terraform to your private VCS providers. The following are examples of private VCS providers that can be managed locally on your private network:
...
There are two sources of information to help diagnose issues with Private VCS and the underlying TFC-Agent upon which this functionality runs on:
