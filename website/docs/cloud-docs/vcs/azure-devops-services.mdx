...
1. In a new browser tab, login to your [Microsoft Entra admin center](https://entra.microsoft.com), click the **Applications** drop-down in the left navigation menu, then click **App registrations**. If you have access to multiple Entra tenants, switch to the tenant in which you want to register the application.
