...
These instructions are for using Bitbucket Cloud for Terraform Cloud's VCS features. Bitbucket Cloud is the cloud-hosted version of Bitbucket; [self-hosted Bitbucket Data Center instances have separate instructions,](/terraform/cloud-docs/vcs/bitbucket-data-center) as do the [other supported VCS providers.](/terraform/cloud-docs/vcs)
