...
On the HCP Terraform **Add VCS Provider** page, click the "register a new OAuth Application" link. This will open GitHub.com in a new browser tab with the OAuth application settings pre-filled.
