...
<!-- BEGIN: TFC:only -->
For beginning users on HCP Terraform, we recommend using our [configuration-free GitHub App](/terraform/cloud-docs/vcs/github-app) to access repositories instead.
<!-- END: TFC:only -->
