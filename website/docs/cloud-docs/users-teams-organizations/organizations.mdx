...
Review the organization name and contact email. Organization owners can choose to change the organization name, contact email, and the default execution mode, or delete the organization. The default execution mode will change the execution mode across all workspaces that are set to use default execution mode, it is initially set as "Remote".
