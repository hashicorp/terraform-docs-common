...
You can access additional information about an aggregated status check in Terraform Cloud by clicking the **Details** link that _X_ provides. This link navigates you to a Terraform Cloud page that offers the consolidated status check results across multiple workspaces, highlighting details such as resource changes and issues that require attention.
