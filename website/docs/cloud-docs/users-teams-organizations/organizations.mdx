...
-> **Note:** Terraform Cloud **Free** Edition includes one policy set of up to five policies. Refer to [Terraform Cloud pricing](https://www.hashicorp.com/products/terraform/pricing) for details.
