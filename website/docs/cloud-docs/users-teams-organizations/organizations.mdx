...
-> **Note:** Terraform Cloud **Free** Edition includes one policy set of up to five policies. Versioned policy sets are available in Terraform Cloud **Plus** Edition. Refer to [Terraform Cloud pricing](https://www.hashicorp.com/products/terraform/pricing) for details.
