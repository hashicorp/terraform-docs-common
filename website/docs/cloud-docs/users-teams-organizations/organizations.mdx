...
-> **Note:** Health Assessments are a paid feature, available as part of the **Business** plan. Refer to [Terraform pricing](https://www.hashicorp.com/products/terraform/pricing) for details.

Enforce health assessments or delegate to workspace preference. Enforcing health assessments overrides workspace settings but does not change them. Refer to [workspace health assessments](/cloud-docs/workspaces/settings/health-assessments) for more information.
