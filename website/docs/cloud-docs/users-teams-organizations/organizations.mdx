...
Organization owners can also create and delete teams, and manage team API tokens. Both owners, and users with [Manage Membership](/cloud-docs/users-teams-organizations/permissions#manage-membership) permissions, can manage the membership of teams. Remember that users must accept an invitation to the organization before you can add them to teams.

[permissions-citation]: #intentionally-unused---keep-for-maintainers

#### Users

Organization owners, and users with [Manage Membership](/cloud-docs/users-teams-organizations/permissions#manage-membership) permissions, can invite Terraform Cloud users into the organization, cancel invitations, and remove existing members.
