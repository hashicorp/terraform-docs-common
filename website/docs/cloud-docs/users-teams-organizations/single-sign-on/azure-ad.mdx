---
page_title: Microsoft Azure Entra ID - Single Sign-on - Terraform Cloud
tfc_only: true
description: >-
  Learn how to configure single sign-on with Azure Entra ID.
---

# Single Sign-on: Microsoft Azure Entra ID

The Microsoft Azure Entra ID SSO integration currently supports the following SAML features:

- Service Provider (SP) initiated SSO
- Identity Provider (IdP) initiated SSO
- Just-in-Time Provisioning

For more information on the listed features, visit the [Microsoft Azure Entra ID SAML Protocol Documentation](https://docs.microsoft.com/en-us/azure/active-directory/develop/single-sign-on-saml-protocol).

## Configuration (Azure Entra ID)

1. Sign in to the Azure portal.
1. On the left navigation pane, select the **Azure Entra ID** service.
...
To edit your Azure SSO configuration settings:
   ...
   1. Paste the contents of the SAML Signing Certificate you downloaded from Microsoft Azure Entra ID.
   1. Save Settings.
...
To configure team management in your Microsoft Azure Entra ID application:
...
-> **Note:** When you configure Azure Entra ID to use Group Claims, it provides Group UUIDs instead of human readable names in its SAML assertions. We recommend [configuring SSO Team IDs](/terraform/cloud-docs/users-teams-organizations/single-sign-on#team-names-and-sso-team-ids) for your HCP Terraform teams to match these Azure Group UUIDs.

If you plan to use SAML to set usernames in your Microsoft Azure Entra ID application:
...
If you namespaced any of your claims, then Microsoft Azure Entra ID passes the attribute name using the format `<claim_namespace/claim_name>`. Consider this format when setting team and username attribute names.
