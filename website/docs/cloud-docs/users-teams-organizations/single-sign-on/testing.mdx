---
page_title: Testing - Single Sign-on - HCP Terraform
tfc_only: true
description: >-
  Use a single sign-on test to finalize your integration. Enabling a single sign-on integration requires a successful test.
---
