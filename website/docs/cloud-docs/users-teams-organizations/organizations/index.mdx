...
The **admin** permission preset must be enabled on your profile to create and manage organizations in the HCP Terraform UI. Refer to [Permissions]() for addtional information. 
...
- [Create workspaces](/terraform/cloud-docs/workspaces/create)
...
You can also view single-value tags that workspaces managers added directly to their workspaces. Refer to [Tags](#tags) in the organization settings reference for additional information.
...
- Add a new single-value workspace tag: [`POST /workspaces/:workspace_id/relationships/tags`](/terraform/cloud-docs/api-docs/workspaces#add-tags-to-a-workspace)
- Delete a single-value workspace tag: [`DELETE /workspaces/:workspace_id/relationships/tags`](/terraform/cloud-docs/api-docs/workspaces#remove-tags-from-workspace)
- Update an existing single-value workspace tag: [`PATCH /workspaces/:workspace_id`](/terraform/cloud-docs/api-docs/workspaces#update-a-workspace)
