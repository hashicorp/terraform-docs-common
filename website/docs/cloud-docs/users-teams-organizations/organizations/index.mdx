...
The organization follows the default policy applied to all workspaces, but members of individual workspaces can set policies for their workspaces that override the organization policy.
