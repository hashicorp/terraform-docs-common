...
~> **This feature is in beta**: The ability to reserve tag keys for the organization is in beta. We do not recommend using it in production environments.

Tags are key-value pairs that you can apply to projects and workspaces. Tags help you organize your projects and resources and track resource consumption. Refer to the following topics for information about creating and managing tags attached to projects and workspaces:
...
1. You can enable the **Disable overrides** option to prevent project and workspace managers from overriding the key. 
