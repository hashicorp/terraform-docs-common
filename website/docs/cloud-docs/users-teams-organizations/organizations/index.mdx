...
There are three types of data retention policies that an organization owner has the ability to set or override: the admin default policy, do not auto-delete, and auto-delete data.

If the admin default policy is selected, all other selections will be disabled by default until the admin default policy checkbox is unchecked.
