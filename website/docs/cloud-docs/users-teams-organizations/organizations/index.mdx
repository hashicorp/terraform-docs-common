...
Tags are key-value pairs that you can apply to projects and workspaces. Tags help you organize your projects and resources, as well as track resource consumption.

Click on **Tags** in the sidebar to view all tags in your organization. You can perform the following actions:

1. Search for a tag key or value.
1. Click on a column header to sort tags.
1. Click the trash icon to delete a tag from the system. Deleting a tag removes it from projects and workspaces it is attached to.

Refer to the following topics for information about creating and managing tags:
