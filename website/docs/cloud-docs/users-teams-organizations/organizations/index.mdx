...
HCP Terraform restricts team creation, team deletion, and management of team API tokens to organization owners and users with the [manage teams](#manage-teams) permission. Organization owners and users with the [manage membership](#manage-membership) permission can manage team membership. 

Remember that users must accept their organization invitations before you can add them to a team.

[permissions-citation]: #intentionally-unused---keep-for-maintainers

#### Users

Organization owners and users with [manage membership](#manage-membership) permissions can invite HCP Terraform users into the organization, cancel invitations, and remove existing members.
