...
On Terraform Enterprise, administrators can restrict your ability to create organizations. Refer to [Administration: General Settings](/terraform/cloud-docs/admin/application/general#organization-creation) for details.
...
Owners and users with the [include secret teams permission](/terraform/cloud-docs/users-teams-organizations/permissions#include-secret-teams) can:
...
HCP Terraform restricts team creation, team deletion, and management of team API tokens to organization owners and users with [manage teams](/terraform/cloud-docs/users-teams-organizations/permissions#manage-teams) permission. Both owners and users with [manage membership](/terraform/cloud-docs/users-teams-organizations/permissions#manage-membership) can manage team membership. Remember that users must accept their invitation to the organization before you can add them to a team.
