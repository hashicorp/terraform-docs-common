...
-> **Note:** If your Terraform Cloud account is created using GitHub or HCP, you cannot manage your password in Terraform Cloud. The password reset link also won't be available, and you will receive an error `user not found - if this is a HCP account, please manage your account settings in HCP.`
