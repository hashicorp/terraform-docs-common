...
Does not grant members any explicit access to projects and workspaces. You can still grant permissions to individual projects or workspaces through [Project Permissions](/terraform/cloud-docs/users-teams-organizations/permissions#project-permissions) and [Workspace Permissions](/terraform/cloud-docs/users-teams-organizations/permissions#workspace-permissions).

#### View all projects

Allows members to view all projects within the organization. This lets users:
- View project names in a given organization.

#### Manage all projects

Allows members to create and manage all projects and workspaces within the organization. In addition to all the permissions granted by “Manage all workspaces”, this also lets users:
