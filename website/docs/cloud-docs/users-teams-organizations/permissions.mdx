...
- Delete the workspace
  - Depending on how the organization has been [configured](/cloud-docs/users-teams-organizations/organizations#general), workspace admins may only be able to delete the workspace if it does not have any [resources under management](/cloud-docs/workspaces/settings#deleting-a-workspace-with-resources-under-management).
