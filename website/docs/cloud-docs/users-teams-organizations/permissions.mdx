...
Separate from workspace permissions, teams can be granted permissions to manage certain resources or settings across an organization. To set these permissions for a team, click **Settings**. Then click **Teams** and select the team name from the list.
