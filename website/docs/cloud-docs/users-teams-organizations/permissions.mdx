...
Allow members to generate module tests for private registry modules. Your organization must be on a Terraform Cloud Business or Plus subscription in order to enable this feature.
