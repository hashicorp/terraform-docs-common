...
Does not grant members any explicit access to projects and workspaces. You can still grant permissions to individual projects or workspaces through [Project Permissions](/cloud-docs/users-teams-organizations/permissions#project-permissions) and [Workspace Permissions](/cloud-docs/users-teams-organizations/permissions#workspace-permissions).

### Manage Policies

Allows members to create, edit, read, list and delete the organization's policies.
