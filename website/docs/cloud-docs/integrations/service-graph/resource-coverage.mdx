...
description: >-
  ServiceNow Service Graph integration allows to import a selected resources into ServiceNow CMDB.
---

# Resource Mapping

The following table outlines how Service Graph Connector for Terraform maps resources from the Terraform state to the ServiceNow CMDB configuration items (CIs).
