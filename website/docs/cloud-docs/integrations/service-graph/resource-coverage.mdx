...
While the default ETL map provided by the application can be utilized without modification, it is also possible to customize it according to the specific requirements of your organization. Check [ETL Mapping Customizations](/terraform/cloud-docs/integrations/service-graph/customizations) for more details.
...
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Cloud Service Account (`cmdb_ci_cloud_service_account`)    | Source Native Key | Resource account number extracted from `arn`                   |
...
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| AWS Datacenter (`cmdb_ci_aws_datacenter`)                  | Source Native Key | Concatenation of region and account number extracted from `arn`|
|                                                            | Object Id         | Region extracted from `arn`                                    |
|                                                            | Region            | Region extracted from `arn`                                    |
|                                                            | Name              | Region extracted from `arn`                                    |
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Virtual Machine Instance (`cmdb_ci_vm_instance`)           | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `id`                                                           |
...
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| AWS Cloud ECS Cluster (`cmdb_ci_cloud_ecs_cluster`)        | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `id`                                                           |
|                                                            | Name              | `name`                                                         |
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
...
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Cloud Network (`cmdb_ci_network`)                          | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `id`                                                           |
|                                                            | Name              | `name`                                                         |
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Cloud DataBase (`cmdb_ci_cloud_database`)                  | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `id`                                                           |
...
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Cloud DataBase Cluster (`cmdb_ci_cloud_db_cluster`)        | Source Native Key | `arn`                                                          |
...
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| DynamoDB Table (`cmdb_ci_dynamodb_table`)                  | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `arn`                                                          |
|                                                            | Location          | Region extracted from `arn`                                    |
|                                                            | Name              | `name`                                                         |
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| DynamoDB Global Table (`cmdb_ci_dynamodb_global_table`)    | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `arn`                                                          |
|                                                            | Name              | `name`                                                         |
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Compute Security Group (`cmdb_ci_compute_security_group`)  | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `id`                                                           |
|                                                            | Location          | Region extracted from `arn`                                    |
|                                                            | Name              | `name`                                                         |
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Cloud Function (`cmdb_ci_cloud_function`)                  | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `arn`                                                          |
|                                                            | Language          | `runtime`                                                      |
...
|                                                            | Operational Status| Defaults to "1" ("Operational")                                |
|------------------------------------------------------------|-------------------|----------------------------------------------------------------|
| Cloud Load Balancer (`cmdb_ci_cloud_load_balancer`)        | Source Native Key | `arn`                                                          |
|                                                            | Object Id         | `id`                                                           |
