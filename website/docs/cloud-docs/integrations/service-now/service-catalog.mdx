...
Starting from version 2.2.0, the Service Catalog app allows you to set the [execution mode](https://developer.hashicorp.com/terraform/cloud-docs/workspaces/settings#execution-mode) for your Terraform Workspaces.
