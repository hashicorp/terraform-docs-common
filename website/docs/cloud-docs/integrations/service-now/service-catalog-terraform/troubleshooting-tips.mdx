...
1. A [HCP Plus tier](/products/terraform/pricing) is required to use this feature. 
...
For additional instructions on customizations, read more on the [Example Customizations page](/terraform/cloud-docs/integrations/service-now/service-catalog-terraform/example-customizations).
