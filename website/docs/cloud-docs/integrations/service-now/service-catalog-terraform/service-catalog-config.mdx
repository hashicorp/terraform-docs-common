...
Additionally, you must have the following information:
...
1. Configure at least one VCS repository in ServiceNow.
...
- Tooltip: A tooltip to display the variable.
...
enabled. Terraform Cloud will queue and apply for these workspaces whenever
