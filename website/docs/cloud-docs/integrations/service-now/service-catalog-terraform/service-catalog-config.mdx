...
Version 2.4.0 also allows you to organize workspaces with custom tags. Use the new "Workspace Tags" field to provide a comma-separated list of tags that will be parsed and attached to the workspace. 
