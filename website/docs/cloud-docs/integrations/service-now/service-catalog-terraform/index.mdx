---
page_title: Set up ServiceNow Service Catalog integration for Terraform
description: Learn how to set up the ServiceNow Service Catalog integration for Terraform.
---

# Set up ServiceNow Service Catalog integration for Terraform
