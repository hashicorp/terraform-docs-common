---
page_title: ServiceNow Service Graph Connector for Terraform resource coverage overview
description: >-
  The ServiceNow Service Graph for Terraform integration imports selected resources from major cloud providers into ServiceNow CMDB.
---
