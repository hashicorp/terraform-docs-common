---
page_title: ServiceNow Service Graph Connector for Terraform overview
description: >-
  Use the ServiceNow Service Graph Connector to enable your users to import Terraform-built infrastructure into ServiceNow CMDB.
---
