---
page_title: Customize the ServiceNow Service Graph Connector for Terraform
description: >-
  Learn how to edit ETL mappings in the ServiceNow Service Graph Connector for Terraform integration.
---
