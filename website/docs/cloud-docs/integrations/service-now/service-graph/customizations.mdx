...
Create a new workspace in your Terraform Cloud organization and build a Terraform resource that you would like to map. It helps to have a Terraform state record of the resource to ensure accurate mapping. 
