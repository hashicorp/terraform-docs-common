...
Sign in to [HCP Terraform](https://app.terraform.io/) and visit your organization’s **Settings** > **Teams** page. Scroll down to the **Team API Token** section and click **Create a team token**.
