...
Styra DAS works with Terraform Cloud to ensure that plans for an apply action are always evaluated against your DAS Terraform OPA policies. To get started, follow the [Integrate with Terraform Cloud](https://docs.styra.com/tutorials/terraform-cloud/introduction) tutorial in the Sophos documentation.
