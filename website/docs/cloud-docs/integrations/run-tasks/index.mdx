...
Blink makes it easy to add approvals checks via interactive Slack notifications to your Terraform workflows, or create event-based automations triggered by Terraform Cloud to enforce compliance, security, or business requirements.
...
To get started, follow the instructions in the [Terraform Cloud integration]([https://www.docs.blinkops.com/docs/Integrations/Terraform/Run%20Tasks](https://www.tines.com/story-library/102061/respond-to-configure-terraform-cloud-run-task) user documentation.
