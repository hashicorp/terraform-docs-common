...
[Rapid7's](https://rapid7.com/) InsightCloudSec enables security teams to provide a single, consistent definition of good across the full CI/CD pipeline, allowing them to evaluate potential risks of Infrastructure as Code (IaC) templates as they are built and pre-deployment.
...
[SpectralOps](https://spectralops.io/) SpectralOps integration with Terraform Cloud & Terraform Enterprise enables security teams to empower their engineers to monitor, classify, and protect their code & infrastructure for security misconfiguration.
