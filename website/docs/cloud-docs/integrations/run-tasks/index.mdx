...
Refer to the [Run Task Integration API](/cloud-docs/api-docs/run-tasks/run-tasks-integration) for the exact payload specification.
...
Refer to the [Run Task Integration API](/cloud-docs/api-docs/run-tasks/run-tasks-integration) for the exact callback specification.
...
To get started, build a workflow from Terraform Cloud template or follow the instructions in the [Terraform Cloud integration](https://www.tines.com/story-library/102061/respond-to-configure-terraform-cloud-run-task) user documentation.
