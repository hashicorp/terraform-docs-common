...
All Terraform Cloud users can use the Terraform Cloud Operator for Kubernetes. Terraform Cloud features [limited to certain tiers](/terraform/cloud-docs/overview) aren't available to the Terraform Cloud Operator for Kubernetes unless you've purchased that corresponding tier.
