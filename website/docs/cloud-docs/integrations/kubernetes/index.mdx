...
The operator's CustomResourceDefinitions (CRD) let you dynamically create Terraform Cloud workspaces using Terraform configuration from a Git repository or the [Terraform Registry](https://registry.terraform.io/), populate workspace variables, and provision infrastructure with Terraform runs.
