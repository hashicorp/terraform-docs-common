...
-> **Note:** Audit logging is available in Terraform Cloud **Plus** Edition. Refer to [Terraform Cloud pricing](https://www.hashicorp.com/products/terraform/pricing) for details.
...
* Generate an [Organization token](/terraform/cloud-docs/users-teams-organizations/api-tokens#organization-api-tokens) within Terraform Cloud
