...
| --------------------------------------- | -------------- | -------------- | -----------------------------------------------------------|
| app.terraform.io or app.eu.terraform.io | tcp/443, HTTPS | Outbound       | Polling for new audit log events via the HCP Terraform API |
...
* Update the hostname to https://app.eu.terraform.io if you use HCP Terraform in Europe
