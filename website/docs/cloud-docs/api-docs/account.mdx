---
page_title: Account API endpoints for HCP Terraform
description: >-
  Use the HCP Terraform API's `/account` endpoint to manage the current user. Learn how to read and update your account's details as well as change your password.
---
