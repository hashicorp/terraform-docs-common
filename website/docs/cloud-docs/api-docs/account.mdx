...
description: >-
  Use the `/account` endpoint to interact with the current Terraform Cloud user. Get user details, update account info, and change your password with the HTTP API.
---
