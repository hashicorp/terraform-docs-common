---
page_title: Applies API for HCP Terraform
description: >-
  Use the HCP Terraform API's `/applies` endpoint to read the results of a Terraform apply and to recover a failed state upload after applying.
---
