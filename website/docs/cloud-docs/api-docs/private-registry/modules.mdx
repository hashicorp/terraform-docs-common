...
| `data.attributes.vcs-repo.branch`             | string  |         | The branch that the module should be pointed to. If this field is omitted then the Registry Module will be tag based.  |
