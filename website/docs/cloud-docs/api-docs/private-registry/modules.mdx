...
description: >-
  Use the `/registry-modules` endpoint to manage modules published to an organization's private Terraform Cloud registry. List, get, create, publish, and delete modules and versions using the HTTP API.
---
