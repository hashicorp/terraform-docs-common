...
| `data.attributes.vcs-repo.branch`             | string  |         | The branch that the module should be pointed to as part of the Branch Based Modules workflow. If this field is omitted then the Registry Module will be tag based.  |
