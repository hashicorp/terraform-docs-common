...
| `:namespace`         | The module namespace that the update will affect. For private modules this is the name of the organization that owns the module.                                                                         |
| `:name`              | The module name that the update will affect.                                                                                                                                                             |
...
|-----------------------------------------------|----------------|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `data.type`                                   | string         |                  | Must be `"registry-modules"`.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `data.attributes.vcs-repo.branch`                        | string         | (previous value) | The repository branch that Terraform will execute tests and publish new versions from. This cannot be used with the `data.attributes.vcs-repo.tags` key.                                                                                                                                                                                     |
