---
page_title: Hosted Provider Versions and Platforms - API Docs - Terraform Cloud
description: >-
  Use the `/registry-providers` to manage hosted providers in your private registry. Create, get, and delete versions, and create, get, and delete platforms using the HTTP API.
---
...
| `:namespace`         | The namespace of the provider for which the version is being created. For hosted providers this is the same as the `:organization_name` parameter.                                                        |
| `:name`              | The name of the provider for which the version is being created.                                                                                                                                           |


Creates a new registry provider version. This endpoint only applies to hosted providers.
...
| `:registry_name`     | Must be `private`.                                                                                                                                                                                                   |
| `:namespace`         | The namespace of the provider for which the version is being deleted. For hosted providers this is the same as the `:organization_name` parameter.                                                                  |
...
You must upload one or more platforms for each version of a hosted provider. After you create a platform, you must upload the platform binary file to the `provider-binary-upload` URL.
...
| `:registry_name`     | Must be `private`.                                                                                                                                                                                                  |
| `:namespace`         | The namespace of the provider for which the platform is being created. For hosted providers this is the same as the `:organization_name` parameter.                                                                |
...
Creates a new registry provider platform. This endpoint only applies to hosted providers.
...
| `:registry_name`     | Must be `private`.                                                                                                                                                                                                     |
| `:namespace`         | The namespace of the provider for which the platform is being deleted. For hosted providers this is the same as the `:organization_name` parameter.                                                                   |
