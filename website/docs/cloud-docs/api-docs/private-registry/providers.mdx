---
page_title: Registry providers API for HCP Terraform
description: >-
  Use the HCP Terraform API's `/registry-providers` endpoint to list, create, get, and delete providers in your private registry.
---
