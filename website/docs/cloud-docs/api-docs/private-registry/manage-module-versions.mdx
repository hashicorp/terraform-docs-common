...
The [registry modules API](/terraform/cloud-docs/api-docs/private-registry/modules#sample-registry-request-private-module) returns data about private registry modules, including a module’s deprecation information.
