...
## Fetch data about a module versions’s deprecation 

The [private registry module API](/terraform/cloud-docs/api-docs/private-registry/modules#sample-registry-request-private-module) returns data about private registry modules, including that module’s deprecation status.
