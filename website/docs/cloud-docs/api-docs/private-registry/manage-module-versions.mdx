...
Use the the module version management API endpoints to deprecate module versions revoke module versions, and revert of status of module versions in your organization’s private registry.
