...
| `filter[status_group]` |   **Optional.** A single status group; the result will only include runs whose status falls under this status group. Options are listed in [Run Status Groups](/terraform/cloud-docs/api-docs/run#run-status-groups).                                                                                                                                        |
...
`GET /organizations/:organizaton_name/runs`

| Parameter      | Description                        |
|----------------|------------------------------------|
| `organizaton_name` | The organization name to list runs for. |
...
| `filter[operation]` | **Optional.** A comma-separated list of run operations; the result will only include runs that perform one of these operations. Options are listed in [Run Operations](/terraform/cloud-docs/api-docs/run#run-operations).                                                                                                                                 |
| `filter[status]`    | **Optional.** A comma-separated list of run statuses; the result will only include runs that are in one of these statuses. Options are listed in [Run States](/terraform/cloud-docs/api-docs/run#run-states).                                                                                                                                         |
| `filter[agent_pool_names]`    | **Optional.** A comma-separated list of agent pool names; the result will only include runs who have used one of these agent pools.                                                                                                                                          |
| `filter[workspace_names]`    | **Optional.** A comma-separated list of workspace names; the result will only include runs belong to one of these workspaces.                                                                                                                                         |
| `filter[source]`    |**Optional.** A comma-separated list of run sources; the result will only include runs that came from one of these sources. Options are listed in [Run Sources](/terraform/cloud-docs/api-docs/run#run-sources).                                                                                                                                       |
| `filter[status_group]` |   **Optional.** A single status group; the result will only include runs whose status falls under this status group. Options are listed in [Run Status Groups](/terraform/cloud-docs/api-docs/run#run-status-groups).                                                                                                                                        |
| `search[user]`      | **Optional.** Searches runs that matches the supplied VCS username.                                                                                                                                                            |
| `search[commit]`    | **Optional.** Searches runs that matches the supplied commit sha.                                                                                                                                                              |
