...
|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `plan_only`      | Indicates the run completed without an apply phase. This is also called a [speculative plan](/terraform/cloud-docs/run/modes-and-options#plan-only-speculative-plan).                |
...
| `empty_apply`    | Specifies the run performed an apply with no changes to resources. This is most commonly used to [upgrade terraform state versions](/terraform/cloud-docs/workspaces/state#upgrading-state). |
