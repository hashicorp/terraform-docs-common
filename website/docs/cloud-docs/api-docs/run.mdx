...
The run operation specifies the Terraform execution mode. You can reference the following list of possible operation modes and use them as query parameters in [workspace runs list](/terraform/cloud-docs/api-docs/run#list-runs-in-a-workspace) and [organization runs list](/terraform/cloud-docs/api-docs/run#list-runs-in-a-workspace).
...
You can use the following sources as query parameters in [workspace runs list](/terraform/cloud-docs/api-docs/run#list-runs-in-a-workspace) and [organization runs list](/terraform/cloud-docs/api-docs/run#list-runs-in-a-workspace).
