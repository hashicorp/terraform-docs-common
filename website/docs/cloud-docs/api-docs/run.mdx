...
The run operation specifies the Terraform execution mode, and you can reference the following list of possible operation modes and use them as runs list query parameters.
...
| `empty_apply`           |  Specifies the run performed an apply with no changes to resources. Most commonly used to upgrade terraform state versions. |
