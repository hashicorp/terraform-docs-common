---
page_title: Runs API for HCP Terraform
description: >-
  Use the `/runs` endpoint to read, get, create, apply, discard, execute, and cancel Terraform runs. You can also list a workspace's or organization's runs.
---
