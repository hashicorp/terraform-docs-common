...
*Applicable for runs list query parameters*

The run operation specifies the mode in which the terraform executed, and you can reference the following list of possible operation modes.

| Operation               | Description                                                                                                                |
|-------------------------|----------------------------------------------------------------------------------------------------------------------------|
| `plan_only`             |  Indicates the run completed without an apply phase. Most commonly known as an speculative run.                            |
...
| `empty_apply`           |  Specifies the run performed an apply with no changes to resources. Most commonly used to upgrade terrafor state versions. |
...
| `filter[operation]` | **Optional.** Options are listed [above](/cloud-docs/api-docs/run#run-operations)   |
| `filter[status]`    | **Optional.** Options are listed [above](/cloud-docs/api-docs/run#run-states)       |
| `filter[source]`    | **Optional.** Options are listed [above](/cloud-docs/api-docs/run#run-states)       |
