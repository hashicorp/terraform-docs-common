...
| `save_plan`      | The run is a saved plan run. It can include both plan and apply phases, but will only become the workspace's current run if a user chooses to apply it.                     |
