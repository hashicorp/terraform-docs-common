...
description: >-
  Use the `/organizations` endpoint to interact with Terraform Cloud organizations. List organizations, entitlement sets, and module producers, and show, create, update, and destroy organizations using the HTTP API.
---
