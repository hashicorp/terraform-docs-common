...
-> **Note:** Sentinel and OPA policies available in the [Terraform Cloud **Team & Governance** tier](https://www.hashicorp.com/products/terraform/pricing), and OPA policies are in beta.

Policy Set Parameters allow the ability for policies to receive parameters for use within the policy.
