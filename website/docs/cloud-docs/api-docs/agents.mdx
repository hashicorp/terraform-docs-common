---
page_title: Agents and agent pools API endpoints for HCP Terraform
description: >-
  Use the HCP Terraform API's `/agents` endpoint to list, show, and delete agents. Use the `/agent-pools` endpoint to list, show, create, update, and delete agent pools.
---
