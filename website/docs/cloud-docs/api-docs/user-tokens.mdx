---
page_title: User tokens API for HCP Terraform
description: >-
 Use the HCP Terraform API's `/authentication-tokens` endpoint to read, create, and destroy user-specific API tokens.
---
