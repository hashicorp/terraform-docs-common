...
This method adds multiple users to a team using the organization membership ID.
...
This method removes multiple users from a team using the user ID. Both users and teams must already exist. This DOES NOT delete the user; it only removes them from this team.
...
This method removes multiple users from a team using the organization membership ID. This DOES NOT delete the user; it only removes them from this team.
