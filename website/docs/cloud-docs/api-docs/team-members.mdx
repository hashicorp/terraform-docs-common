---
page_title: Team membership API for HCP Terraform
description: >-
 Use the HCP Terraform API's `/relationships` endpoints to add and remove users from teams using an account ID or organization membership ID.
---
