---
page_title: API stability policy for HCP Terraform and Terraform Enterprise
description: >-
  Learn how HashiCorp plans for stability, backward compatibility, and deprecation for the HCP Terraform and Terraform Enterprise APIs.
---
