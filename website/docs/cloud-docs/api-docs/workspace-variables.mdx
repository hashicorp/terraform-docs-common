---
page_title: Workspace variables API for HCP Terraform
description: >-
  Use the HCP Terraform API's workspace `/vars` endpoint to manage workspace-specific variables. Read, create, update, and delete workspace variables.
---
