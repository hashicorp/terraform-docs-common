---
page_title: Variables API endpoints for HCP Terraform
description: >-
   Use the HCP Terraform API's `/vars` endpoint to manage organization-level variables. Learn how to list, create, update, and delete variables using the API.
---
