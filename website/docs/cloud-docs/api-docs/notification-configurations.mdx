...
| Drifted            | `"assessment:drifted"`  | When an assessment of the workspace has found drift                                                      |
