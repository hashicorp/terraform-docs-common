...
Workspace events include detailed information about workspace-level validation events like [health assessments](/cloud-docs/workspaces/settings/health-assessments) if you enable them for the workspace. Much of the information provides details about the associated [assessment result](/cloud-docs/api-docs/assessment-results), which Terraform Cloud uses to track instances of continuous validation. Generic notifications for workspace events contain the following information:
...
| `details.new_assessment_result.all_checks_succeeded`  | bool | Whether or not all conditions passed.                                         |
| `details.new_assessment_result.checks_passed`         | number | The number of resources and outputs passing their conditions.               |
| `details.new_assessment_result.checks_failed`         | number | The number of resources and outputs with one or more failing conditions.    |
| `details.new_assessment_result.checks_errored`        | number | The number of resources and outputs that had a condition error.             |
| `details.new_assessment_result.checks_unknown`        | number | The number of resources and outputs that had conditions left unevaluated.   |
| `details.new_assessment_result.drifted`      | bool   | Whether or not assessment detected drift.                                            |
| `details.new_assessment_result.resources_drifted`     | number| The number of resources drifted.                                             |
| `details.new_assessment_result.resources_undrifted`   | number| The number of resources not drifted.                                         |
...
| `details.prior_assessment_result.all_checks_succeeded`  | bool | Whether or not all conditions passed.                                       |
| `details.prior_assessment_result.checks_passed`         | number | The number of resources and outputs passing their conditions.             |
| `details.prior_assessment_result.checks_failed`         | number | The number of resources and outputs with one or more failing conditions.  |
| `details.prior_assessment_result.checks_errored`        | number | The number of resources and outputs that had a condition error.           |
| `details.prior_assessment_result.checks_unknown`        | number | The number of resources and outputs that had conditions left unevaluated. |
| `details.prior_assessment_result.drifted`    | bool   | Whether or not assessment detected drift.                                            |
| `details.prior_assessment_result.resources_drifted`     | number| The number of resources drifted.                                           |
| `details.prior_assessment_result.resources_undrifted`   | number| The number of resources not drifted.                                       |
