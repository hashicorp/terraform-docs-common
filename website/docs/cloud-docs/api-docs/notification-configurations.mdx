...
| Applying           | `"run:applying"`        | A run enters the [Apply stage](/cloud-docs/run/states#10-the-apply-stage), where Terraform makes the infrastructure changes described in the plan.                            |
