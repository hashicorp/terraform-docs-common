...
| Drift Check Failed | `"assessment:failed`"   | A drift detection assessment failed. This is only available if drift detection is enabled for the workspace.   Not available in Terraform Enterprise.                                       |
