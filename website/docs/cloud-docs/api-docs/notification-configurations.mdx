---
page_title: Notification configuration API for HCP Terraform
description: >-
 Use the HCP Terraform API's `/notification-configurations` endpoint to read, create, update, verify, and delete workspace configurations and to create team configurations.
---
