...
By default, all teams have a default email notification configuration defined with no users assigned. With no users assigned, HCP Terraform sense email notifications to all team members.
