...
| `uploaded`  | The state version has been fully processed and can be used in runs. |
| `backing_data_soft_deleted`  | The backing files associated with this state version have been soft-deleted. The backing data can be restored before it is permanently deleted if need be. |
...
## Soft-Delete a State Version

`POST /api/v2/state-versions/:external_id/actions/soft_delete_backing_data`
...
| Parameter           | Description                          |
|---------------------|--------------------------------------|
| `:external_id` | The external ID of the state version to soft-delete. |

| Status  | Response                  | Reason                                                                                                        |
|---------|---------------------------|---------------------------------------------------------------------------------------------------------------|
| [200][] | [JSON API document][]     | Successfully initiated the soft-delete process.                                                               |
| [400][] | [JSON API error object][] | Transitioning state to `backing_data_soft_deleted` was unsuccessful.                                          |
| [404][] | [JSON API error object][] | State version was not found or user unauthorized to perform action.                                           |
...
## Restore a Previously Soft-Deleted State Version

`POST /api/v2/state-versions/:external_id/actions/restore_backing_data`
...
| Parameter           | Description                          |
|---------------------|--------------------------------------|
| `:external_id` | The external ID of the state version to restore. |

| Status  | Response                  | Reason                                                                                                        |
|---------|---------------------------|---------------------------------------------------------------------------------------------------------------|
| [200][] | [JSON API document][]     | Successfully initiated the restore process.                                                                   |
...
`POST /api/v2/state-versions/:external_id/actions/permanently_delete_backing_data`
...
| Status  | Response                  | Reason                                                                                                        |
|---------|---------------------------|---------------------------------------------------------------------------------------------------------------|
| [200][] | [JSON API document][]     | Successfully initiated the permanently delete process.                                                        |
