...
| `backing_data_soft_deleted`  | The backing files associated with this state version have been soft-deleted by Terraform Enterprise. The backing data can be restored before it is permanently deleted if need be. |
| `backing_data_permanently_deleted`  | The backing files associated with this state version have been permanently-deleted by Terraform Enterprise, and can no longer be restored. |
