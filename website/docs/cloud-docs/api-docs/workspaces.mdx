...
| `data.relationships.project.data.id`            | string  |           | The ID of the project to create the workspace in. You must supply a project ID if no default project exists. You must have permission to create workspaces in the project, either by organization-level permissions or team admin access to a specific project.                                                                                                                                                                                                                        |
