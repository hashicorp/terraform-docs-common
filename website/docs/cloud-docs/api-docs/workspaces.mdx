...
| `data.attributes.file-triggers-enabled`       | boolean | `true`    | Whether to filter runs based on the changed files in a VCS push. If enabled it uses either `trigger-prefixes` in conjunction with `working_directory` or `trigger-patterns` to describe a set of triggers upon which a run will be triggered. If disabled, any push will trigger a run.                                                                                                                                                                                                                         |
...
| `data.attributes.trigger-patterns`            | array   | `[]`      | List of repository-root-relative glob patterns which describe files tracked for changes.                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
A run will be triggered in this workspace when changes are detected:
- in any folder tree which has the leaf folder named `networking` and the change was made in a file with the extension `tf`
- in any file changed in the folder `/base`, no subfolders are included
- in any file changed in the folder `/submodule` and all its subfolders
...
| `data.attributes.file-triggers-enabled`       | boolean        | (previous value) | Whether to filter runs based on the changed files in a VCS push. If enabled it uses either `trigger-prefixes` in conjunction with `working_directory` or `trigger-patterns` to describe a set of triggers upon which a run will be triggered. If disabled, any push will trigger a run.                                                                                                     |
...
| `data.attributes.trigger-patterns`            | array          | (previous value) | List of repository-root-relative glob patterns which describe files tracked for changes.                                                                                                                                                                                                                                                                                                    |
