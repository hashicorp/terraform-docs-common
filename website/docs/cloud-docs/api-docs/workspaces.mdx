...
| `data.relationships.tag-bindings`            | array  | `[]`          | A list
of tags to bind to this workspace. If left blank, the workspace will be created
without tag bindings. You must have permission to manage tags.                                                                                                                                                                                                                        |
...
## Add single-value tags to a workspace

This endpoints adds one or more single-value tags to the workspace. The workspace must already exist, and any
