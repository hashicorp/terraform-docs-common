...
[HCP Terraform agents](/terraform/cloud-docs/api-docs/agents) are a solution to allow HCP Terraform to communicate with isolated, private, or on-premises infrastructure.
