...
-> **Note:** Workspace creation is restricted to the owners team, teams with the "Manage all workspaces" permission, and the [organization API token](/terraform/cloud-docs/users-teams-organizations/api-tokens#organization-api-tokens).
