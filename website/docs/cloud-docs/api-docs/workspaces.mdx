...
_List flat string tags attached to the workspace:_
...
_List key-value tags bound directly to the workspace:_
...
_List all key-value tags bound to the workspace, including those inherited from the parent project:_
