...
| `data.attributes.drift_detection`             | boolean | `false` | Whether workspace is expected to be have drift detection checks. Only available for Busines tier organizations, workspaces running Terraform 0.15.4 or greater, and operating in Remote execution mode |
...
| `data.attributes.drift_detection`             | boolean | `false` | Whether workspace is expected to be have drift detection checks. Only available for Business tier organizations, workspaces running Terraform 0.15.4 or greater, and operating in Remote execution mode |
