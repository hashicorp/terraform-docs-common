...
### Task result callback event

A Terraform Cloud organization emits this event when a task result's `callback` action occurs. Alongside the [standard audit trail fields](#standard-response-schema), this event response includes the following fields:
...
Description of what a workspace task is.

#### Create

A Terraform Cloud organization emits this event when someone in your organization creates a workspace task. Alongside the [standard audit trail fields](#standard-response-schema), this event response includes the following fields:
...
A Terraform Cloud organization emits this event when someone in your organization updates a workspace task. Alongside the [standard audit trail fields](#standard-response-schema), this event response includes the following fields:
...
A Terraform Cloud organization emits this event when someone in your organization destroys a workspace task. Alongside the [standard audit trail fields](#standard-response-schema), this event response includes the following fields:
...
Description of what a workspace comment is.
...
### Data retention policy destroy event
...
### Registry module events destroy version event
...
Description of what a workspace is.
...
### Policy Check process audit log event

A Terraform Cloud organization emits this event when processing an audit log event related to policy checks. Alongside the [standard audit trail fields](#standard-response-schema), this event response includes the following fields:
...
### Policy Evaluation process audit log event

A Terraform Cloud organization emits this event when processing an audit log event related to policy evaluations. Alongside the [standard audit trail fields](#standard-response-schema), this event response includes the following fields:
