...
A Terraform Cloud organization emits this event when someone in your organization creates a run task for a workspace (`workspace_task`). Alongside the [standard audit trail fields](#standard-response-fields), this event response includes the following fields:
...
A Terraform Cloud organization emits this event when someone in your organization updates a run task for a workspace (`workspace_task`). Alongside the [standard audit trail fields](#standard-response-fields), this event response includes the following fields:
...
A Terraform Cloud organization emits this event when someone in your organization destroys a run task for a workspace (`workspace_task`). Alongside the [standard audit trail fields](#standard-response-fields), this event response includes the following fields:
