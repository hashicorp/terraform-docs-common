...
[Projects](/terraform/cloud-docs/projects/managing) let you organize your workspaces and scope access to workspace resources.
...
### Overriden, canceled, and force canceled
