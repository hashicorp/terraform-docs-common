...
A Terraform Cloud organization emits this event when processing an audit log event related to policy checks. Alongside the [standard audit trail fields](#standard-response-fields), this event response includes the following fields:
