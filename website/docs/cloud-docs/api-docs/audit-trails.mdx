...
| `stack`                      | `create_destroy_plan` ,`delete_deployment` ,`delete` ,`force_delete` ,`latest_output_summary` ,`set_agent_pool` ,`update_configuration` ,`update` | Events related to stacks.                              |
