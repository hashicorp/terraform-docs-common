---
page_title: Plans API for HCP Terraform
description: >-
  Use the HCP Terraform API's `/plans` endpoint to show a Terraform run plan or generate JSON-formatted execution plans.
---
