...
The No-Code Provisioning API allows you to establish and configure a list of Terraform Modules that can be used in No-Code Provisioning workflows within your Terraform Cloud organization. For more information, see our documentation on [designing no-code-ready modules](/terraform/cloud-docs/no-code-provisioning/module-design) and [provisioning no-code infrastructure](/terraform/cloud-docs/no-code-provisioning/provisioning).
...
`data.attributes.version-pin` | string   |  (latest version of the module) | The version of the module that should be used in No-Code Provisioning workflows.
`data.attributes.enabled` | boolean   |  `false`  | Set to `true` in order to enable No-Code Provisioning workflows.
...
--- | --- | --- | ---
`data.type` | string | | Must be `"no-code-modules"`.
`data.attributes.version-pin` | string   | (previous value) | The version of the module that should be used in No-Code Provisioning workflows.
`data.attributes.enabled` | boolean   | (previous value) | Set to `true` in order to enable No-Code Provisioning workflows of `false` to disable.
...
`data.relationships.variable-options.data[].id` | string | (new value) | The ID of an existing variable-options set. If set, the existing options with this ID will be replaced. If unset, a new variable-option set will be created.
`data.relationships.variable-options.data[].type` | string | | Must be `"variable-options"`
`data.relationships.variable-options.data[].attributes.variable-name` | string | | The name of a variable within the module.
`data.relationships.variable-options.data[].attributes.variable-type` | string | | The data type for the variable. Can be [any type supported by Terraform](/terraform/language/expressions/types#types).
`data.relationships.variable-options.data[].attributes.options` | Any[] | | A list of allowed values for the variable.
