...
-> **Note**: The `enforce` property is also deprecated in the response, and is provided for backwards compatibility.
...
-> **Note**: This sample is using the deprecated `enforce` property.
