...
description: >-
  Use the `/policies` endpoint to manage your available Sentinel and OPA policies. List, show, create, upload, update and delete policies using the HTTP API.
---
...
- Refer to [Defining Sentinel Policies](/cloud-docs/policy-enforcement/sentinel) for details about writing Sentinel code.
- Refer to [Defining OPA Policies](/cloud-docs/policy-enforcement/opa) for details about writing OPA code.
