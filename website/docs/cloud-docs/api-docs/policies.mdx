...
| Parameter    | Description                                                                 |
| ------------ | --------------------------------------------------------------------------- |
| `:policy_id` | The ID of the policy to show. Use the [List Policies](/terraform/cloud-docs/api-docs/policies#list-policies) endpoint to find IDs. |
...
| Parameter    | Description                                                                                                                          |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------ |
| `:policy_id` | The ID of the policy to upload code to. Use the [List Policies](/terraform/cloud-docs/api-docs/policies#list-policies) endpoint (or the response to a "Create Policy" request) to find IDs. |
...
| Parameter    | Description                                                                   |
| ------------ | ----------------------------------------------------------------------------- |
| `:policy_id` | The ID of the policy to update. Use the [List Policies](/terraform/cloud-docs/api-docs/policies#list-policies) endpoint to find IDs. |
...
| Parameter    | Description                                                                   |
| ------------ | ----------------------------------------------------------------------------- |
| `:policy_id` | The ID of the policy to delete. Use the [List Policies](/terraform/cloud-docs/api-docs/policies#list-policies) endpoint to find IDs. |
