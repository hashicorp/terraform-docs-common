...
| `data.attributes.api-url`            | string |         | The base URL of your VCS provider's API (e.g. `"https://api.github.com"` or `"https://ghe.example.com/api/v3"` or `"https://gitlab.com/api/v4"`). Refer VCS provider docs for the API URL.     |
