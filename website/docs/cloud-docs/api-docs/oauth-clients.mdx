...
description: >-
  Use the `/oauth-clients` endpoint to manage OAuth connections between your organization and a VCS provider. List, show, create, update, and destroy clients using the HTTP API.
---
...
~> **Note:** This endpoint does not currently support creation of a Bitbucket Cloud, Bitbucket Data Center, or Azure DevOps Services OAuth Client.
...
| `data.attributes.secret`             | string |         | The OAuth Client secret. For Bitbucket Data Center, this secret is the the text of the SSH private key associated with your Bitbucket Data Center Application Link.                                      |
...
| `data.attributes.secret`         | string | (previous value) | The OAuth Client secret. For Bitbucket Data Center, this secret is the the text of the SSH private key associated with your Bitbucket Data Center Application Link.                                    |
