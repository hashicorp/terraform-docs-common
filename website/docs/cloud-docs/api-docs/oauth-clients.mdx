...
description: >-
  Use the `/oauth-clients` endoint to manage OAuth connections between your organization and a VCS provider. List, show, create, update, and destroy clients using the HTTP API.
---
