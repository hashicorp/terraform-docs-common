...
| `data.attributes.api-url`            | string |         | The base URL as per your VCS provider's API documentation (e.g. `"https://api.github.com"` or `"https://ghe.example.com/api/v3"` or `"https://gitlab.com/api/v4"`).                            |
