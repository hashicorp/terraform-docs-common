...
description: >-
  Use the `/configuration-versions` endpoint to interact with configuration versions for a workspace. List, show, and create configuration versions and their files using the HTTP API.
---
