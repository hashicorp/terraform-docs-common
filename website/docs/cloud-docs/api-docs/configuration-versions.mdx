---
page_title: Configuration versions API for HCP Terraform
description: >-
  Use the HCP Terraform API's `/configuration-versions` endpoint to list, show, and create configuration versions and their files within a workspace.
---
