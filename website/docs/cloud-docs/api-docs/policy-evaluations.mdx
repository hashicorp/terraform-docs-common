...
Policy evaluations are run within the [Terraform Cloud agents](/terraform/cloud-docs/api-docs/agents) in HCP Terraform's infrastructure. Policy evaluations do not have access to cost estimation data.
