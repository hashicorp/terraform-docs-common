...
## 2023-11-13
* Add configurable data retention policies to [configuration versions](/terraform/cloud-docs/api-docs/configuration-versions) and [state versions](/terraform/cloud-docs/api-docs/state-versions), which allows Terraform Enterprise to automatically delete old configuration versions and state versions. Configurable data retention policies are available in the following TFE Release: `v202311-1`.
