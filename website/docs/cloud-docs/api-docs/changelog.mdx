...
* Add [Attach a Policy Set to projects](/terraform/cloud-docs/api-docs/policy-sets#attach-a-policy-set-to-projects) and [Detach a Policy Set to projects](/terraform/cloud-docs/api-docs/policy-sets#detach-a-policy-set-to-projects) API endpoints
