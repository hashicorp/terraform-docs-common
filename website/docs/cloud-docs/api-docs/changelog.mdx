...
## 2023-08-02
* Update [Workspaces API](/terraform/cloud-docs/api-docs/workspaces) to support `auto-apply-run-trigger` attribute which controls whether run trigger runs should be auto applied.
