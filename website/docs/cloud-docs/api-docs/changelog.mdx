...
* Terraform cloud now sets the `configuration_version_download_url`, `configuration_version_id`, and `workspace_working_directory` properties of the [Run Task Request](/terraform/cloud-docs/api-docs/run-tasks/run-tasks-integration#request-body) for all stages.
