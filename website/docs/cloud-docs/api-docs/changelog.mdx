...
## 2023-09-08
* Updated the [Organization API](/terraform/cloud-docs/api-docs/organizations) to include `default-execution-mode` and `default-agent-pool`.
* Updated the [Workspaces API](/terraform/cloud-docs/api-docs/workspaces) to include the new `setting-overwrites` object to allow for overwriting the new organization defaults.
