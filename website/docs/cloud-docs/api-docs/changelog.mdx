...
* Add support for [Streamlined Run Task Reviews](/terraform/cloud-docs/integrations/run-tasks), enabling high fidelity results to be returned from Run Task integrations
  * [Terraform Cloud Run Task API](/terraform/cloud-docs/api-docs/run-tasks/run-tasks) updates to enable Streamlined Run Task Reviews
  * [Run Task Integration API](/terraform/cloud-docs/api-docs/run-tasks/run-tasks-integration) guides integrations through sending rich results
  * Run Task Payload [JSON Schema](/schema/structured-run-task-results-schema.json)
