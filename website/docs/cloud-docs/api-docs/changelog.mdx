...
## 2025-07-11
* Update existing [workspaces API documentation](/terraform/cloud-docs/api-docs/workspaces) references to organization-level default with the new project-level default.
...
* Update existing [projects documentation](/terraform/cloud-docs/agents/agent-pools) to include new `default-execution` flow.
