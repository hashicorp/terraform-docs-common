---
page_title: API Changelog for HCP Terraform and Terraform Enterprise
page_id: api-changelog
description: >-
  Use this log of HCP Terraform and Enterprise API changes to track new features and evolving functionality over time.
---
...
## 2025-01-30
* Remove beta tags from documentation for Explorer, Change requests and Team notifications.
* Adding Change requests list page image
* Updating workspace show endpoint to include `unarchived-workspace-change-requests-count` attribute.
