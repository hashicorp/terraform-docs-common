...
* Add support for [Structured Run Task Results](/terraform/cloud-docs/integrations/run-tasks), enabling high fidelity results to be returned from Run Task integrations
  * [Terraform Cloud Run Task API](/terraform/cloud-docs/api-docs/run-tasks/run-tasks) updates to enable Structured Run Task Results
  ...
  * Structured Run Task Results JSON Schema
