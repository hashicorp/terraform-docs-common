...
##2024-05-23
* Update [Registry Modules API](/terraform/cloud-docs/api-docs/private-registry/modules#create-a-module-version) to detail how to publish a new version for a branch based module.
