...
tfc_only: true
description: >-
  Use the `/meta/ip-ranges` endpoint to query Terraform Cloud's IP ranges. Get a list of the IP ranges used by Terraform Cloud using the HTTP API.
---
...
IP Ranges provides a list of Terraform Cloud's IP ranges. For more information about Terraform Cloud's IP ranges, view our documentation about [Terraform Cloud IP Ranges](/terraform/cloud-docs/architectural-details/ip-ranges).
