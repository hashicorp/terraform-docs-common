---
page_title: Organization tokens API reference for HCP Terraform
description: >-
  Use the HCP Terraform API's `/authentication-token` endpoint to generate and delete organization-level API tokens.
---
