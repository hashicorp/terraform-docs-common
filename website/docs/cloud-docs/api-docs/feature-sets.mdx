...
tfc_only: true
description: >-
  Requests and responses to show available feature sets, and a Terraform Cloud organization's feature set, with the feature sets API endpoint.
---
...
Feature sets represent the different [pricing plans](/cloud-docs/overview) available to Terraform Cloud organizations. An organization's [entitlement set](/cloud-docs/api-docs#feature-entitlements) is calculated using its [subscription](/cloud-docs/api-docs/subscriptions) and feature set.
