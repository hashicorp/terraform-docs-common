---
page_title: Policy sets API for HCP Terraform
description: >-
  Use the `/policy-sets` endpoint to read, create, delete, update and version Sentinel and OPA policy sets. Also, attach, exclude, and detach policy sets to workspaces and projects.
---
