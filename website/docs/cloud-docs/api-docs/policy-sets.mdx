...
| `data.relationships.exclusions`               | array\[object] | (previous value) | An array of references to workspaces that the policy set should not be assigned to. Sending an empty array clears all exclusions assignments. You can only specify this attribute when `data.attributes.global` is `false`.                                                                                      |                                                                                                                                          |
