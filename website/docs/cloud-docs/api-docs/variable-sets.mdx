...
You need [**Read** variables permission](/terraform/cloud-docs/users-teams-organizations/permissions#general-workspace-permissions) to view the variables for a particular workspace and **Read** variable set permission to view the variable sets in the owning organization or project. To create or edit variable sets, your team must have **Manage variable sets** access.
...
| `data.relationships.parent`           | object  | Organization that the  variable set belongs to                                           | The parent that should own the variable set. If the parent is a project, `global` must be set to false.                                      |
| `data.relationships.parent.data.type` | string  | `"organizations"`                                                                        | The resource type of the parent that should own the variable set. Valid values are `organizations` or `projects`.                            |
| `data.relationships.parent.data.id`   | string  | ID of organization that the variable set belongs to.                                     | The ID of the parent that should own the variable set.                                                                                       |
...
HCP Terraform does not allow changing the parent of a variable set. The variable set must be deleted and recreated in the new parent instead.
