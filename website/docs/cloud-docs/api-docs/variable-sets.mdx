...
To create, edit, or apply organization-owned variable sets, you must be part of a team with [manage all workspaces](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-workspaces) or [manage all projects](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-projects) permission. To create, edit, or apply project-owned variable sets, you must be part of a team with Write, Maintain, or Admin access to the project or the [**manage all projects**](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-projects) permission.

You must have the [**Read** variables permission](/terraform/cloud-docs/users-teams-organizations/permissions#general-workspace-permissions) to view the variables applied from a variable set for a particular workspace.
...
| `data.relationships.parent.data.id`   | string  | ID of organization that the variable set belongs to.                                     | The ID of the parent that owns the variable set.                                                                                       |
...
HCP Terraform does not allow you to change which organization or project is the parent of a variable set. Instead, you must delete and recreate that variable set in the project or organization that you want to own that set.
