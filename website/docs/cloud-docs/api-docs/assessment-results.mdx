...
An Assessment Result is the summary record of an instance of continuous validation.

## Show Assessment Result

Any user with read access to a workspace may see assessment results for the workspace.
