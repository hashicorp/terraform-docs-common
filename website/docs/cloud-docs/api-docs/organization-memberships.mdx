...
description: >-
  Use the `/organization-memberships` endpoint to manage user membership within a Terraform Cloud organization. Invite users, and list, show, and remove memberships using the HTTP API.
---
