...
| [404][] | [JSON API error object][] | Stack not found, or user unauthorized to perform the destroy plan |
| [409][] | [JSON API error object][] | Stack is not safe to delete because it is managing resources       todo                                 |
...
| [404][] | [JSON API error object][] | Stack not found, or user unauthorized to perform plan approval |
| [409][] | [JSON API error object][] | Stack is not safe to delete because it is managing resources                                       |
