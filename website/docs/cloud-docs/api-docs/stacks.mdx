...
| `POST` | `/stacks/:stack_id/delete` | Call this endpoint to [delete a stack](#safe-delete-a-stack).|
| `POST` | `/stacks/:stack_id/force-delete` | Call this endpoint to [force delete a stack](#force-delete-a-stack).|
...
This endpoint creates a destroy plan against the specified stack deployment.
