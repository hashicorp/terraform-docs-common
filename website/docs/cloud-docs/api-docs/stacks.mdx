...
| `GET` | `/stacks/:stack_plan_id/stack-events` | Call this endpoint to [list stack events](#list-stack-events).|
...
| `POST` | `/stack-diagnostics/acknowledge` | Call this endpoint to [acknowledge a stack diagnostic](#acknowledge-stack-diagnostic).|
...
| `POST` | `/stacks/:stack_id/stack-deployments/:deployment_name/force-delete-deployment` | Call this endpoint to [force delete deployment](#force-delete-deployment).|
  ...
  "data": {
    ...
    "attributes": {
      ...
      "vcs-repo": {
          ...
          "tags-regex": null,
          "sparse-checkout-pattern": "",
          "identifier": "aaabdelgany/pet-nulls-stack",
          "display-identifier": "aaabdelgany/pet-nulls-stack",
          "oauth-token-id": "ot-t3remoFJPeuLk1Mz",
          "repository-http-url": "https://github.com/aaabdelgany/pet-nulls-stack",
          "service-provider": "github",
          "trigger-disabled": false
      },
      "speculative-enabled": false,
  ...
  "data": [
    {
      ...
      "attributes": {
        ...
        "error-message": null,
        "diags": null,
        "event-stream-url": "https://tfcdev-edbf8d57.ngrok.io/_",
...
Calling this endpoint force-deletes the specified stack deployment.
