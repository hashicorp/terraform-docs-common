...
| Method | Path | Action |
| --- | --- | --- |
| `POST` | `/organizations/:organization_name/stacks` | Call this endpoint to [create a stack](#create-a-stack).|
...
| `GET` | `/stack-configurations/:stack_configuration_id/prepared-source` | Call this endpoint to [fetch stack configuration source bundle](#fetch-stack-configuration-source-bundle).|

## Create a stack

This endpoint creates a stack for an organization.

`POST /organizations/:organization_name/stacks`
...
`GET /stack-configurations/:stack_configuration_id/prepared-source`
