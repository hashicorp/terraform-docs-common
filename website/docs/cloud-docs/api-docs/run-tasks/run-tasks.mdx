...
You may also configure the run task to begin during a specific [run stage](/cloud-docs/run/states). Run tasks are configured to use the [Post-Plan Stage](/cloud-docs/run/states#5-the-post-plan-stage) by default.
