...
| `data.attributes.global-configuration.stages` **(beta)**            | array of string |         | (Optional) The stages of the run lifecycle when the run task should begin. Must be one or more of `"pre_plan"`, `"post_plan"`, `"pre_apply"`, or `"post_apply"`. |
...
| `data.attributes.stages`            | array of string | `["post_plan"]` | The stages of the run lifecycle when the run task should begin. Must be one or more of `"pre_plan"`, `"post_plan"`, `"pre_apply"`, or `"post_apply"`.                      |
...
| `data.attributes.stage`             | string          | (previous value) | **DEPRECATED** Use `stages` instead. The stage in the run lifecycle when the run task should begin. Must be `"pre_plan"`, `"post_plan"`, `"pre_apply"`, or `"post_apply"`. |
| `data.attributes.stages`            | array of string | (previous value) | The stages of the run lifecycle when the run task should begin. Must be one or more of `"pre_plan"`, `"post_plan"`, `"pre_apply"`, or `"post_apply"`.                      |
