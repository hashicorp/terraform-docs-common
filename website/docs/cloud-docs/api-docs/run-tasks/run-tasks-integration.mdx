...
The example below shows a complete payload explaining the data structure of a callback payload looks like, including all necessary fields and their respective values.
