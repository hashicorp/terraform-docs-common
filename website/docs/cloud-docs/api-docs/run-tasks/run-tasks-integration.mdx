...
| `stage`                              | string  | `pre_plan`, `post_plan`, `pre_apply`, `post_apply` | The [run stage](/terraform/cloud-docs/run/states) when Terraform Enterprise triggers the run task.                                                                                                                  |
...
| `run_app_url`                        | string  |                                      | URL within Terraform Enterprise to the run.                                                                                                                                                                         |
