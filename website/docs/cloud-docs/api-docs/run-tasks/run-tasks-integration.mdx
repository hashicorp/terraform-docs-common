...
description: >-
  Use run tasks to make requests when a Terraform Cloud run reaches a specific phase. Learn about the run task request and callback formats. 
---
...
| `is_speculative`                | bool    |                          | Whether the task is part of a [speculative run](/cloud-docs/run/remote-operations#speculative-plans).       |
...
| Key path                             | Type   | Values | Description                                                                                                                                                                                      |
|--------------------------------------|--------|--------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `configuration_version_id`           | string |        | The ID of the [configuration version](/cloud-docs/api-docs/configuration-versions) for the run.                                                                                                      |
...
| `workspace_working_directory`        | string |        | The working directory specified in the run's [workspace settings](/cloud-docs/workspaces/settings#terraform-working-directory).                                                                                                     |
