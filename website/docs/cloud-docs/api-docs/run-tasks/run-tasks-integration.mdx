...
| `stage`                         | string  | `pre_plan`, `post_plan`, `pre_apply` | The [stage](/cloud-docs/run/states) the task was triggered at.                                              |
...
| `configuration_version_download_url` | string |        | The URL to [download the configuration version](cloud-docs/api-docs/configuration-versions#download-configuration-files). This is `null` if the configuration version cannot be downloaded. |
