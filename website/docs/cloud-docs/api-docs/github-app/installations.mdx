...
You can create a GitHub App installations using the Terraform Cloud UI. Learn how to [create a GitHub App installation](/terraform/cloud-docs/vcs/github-app).
