...
-> **Note:** You can only use this API if you have already authorized the Terraform Cloud GitHub App. Manage your [GitHub App token](/terraform/cloud-docs/users-teams-organizations/users#github-app-oauth-token) from **User Settings** > **Tokens**.
