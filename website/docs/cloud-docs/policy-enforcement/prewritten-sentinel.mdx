...
- [`terraform-AWS-Prewritten-Policy-Set`](https://registry.terraform.io/modules/hashicorp/terraform-AWS-Prewritten-Policy-Set/latest) 
...
The `terraform-AWS-Prewritten-Policy-Set` repository is a superset of the `policy-library-CIS-Policy-Set-for-AWS-Terraform` and `policy-library-FSBP-Policy-Set-for-AWS-Terraform` repositories.
...
1. Go to the module in the Terraform registry and copy the code generated in the **Provision Instructions** tile. The following modules are available:
   - [`terraform-AWS-Prewritten-Policy-Set`](https://registry.terraform.io/modules/hashicorp/terraform-AWS-Prewritten-Policy-Set/latest)
   - [`CIS-Policy-Set`](https://registry.terraform.io/modules/hashicorp/CIS-Policy-Set/AWS/latest): This module is deprecated. Use `terraform-AWS-Prewritten-Policy-Set` instead. 
