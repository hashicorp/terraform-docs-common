...
1. Go to the module in the Terraform registry and copy the code generated in the **Provision Instructions** tile. The following modules are available:
   - [CIS-Policy-Set](https://registry.terraform.io/modules/hashicorp/CIS-Policy-Set/AWS/latest)
   - [FSBP-Policy-Set](https://registry.terraform.io/modules/hashicorp/FSBP-Policy-Set/AWS/latest)
