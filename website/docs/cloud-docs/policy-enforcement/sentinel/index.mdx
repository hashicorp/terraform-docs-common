...
You use the [Sentinel policy language](https://docs.hashicorp.com/sentinel/language) to define Sentinel policies. Then you can create one or more [policy sets](/cloud-docs/policy-enforcement/manage-policy-sets) to add to Terraform Cloud workspaces.
