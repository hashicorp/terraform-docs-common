...
- [tfrun](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfrun) - Access data associated with a [run in Terraform Cloud](/terraform/cloud-docs/run/remote-operations). For example, you could retrieve the run's workspace.
