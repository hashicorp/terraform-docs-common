...
[import-tfconfig]: /cloud-docs/policy-enforcement/sentinel/import/tfconfig

[import-tfstate]: /cloud-docs/policy-enforcement/sentinel/import/tfstate
...
[iterate-over-modules]: /cloud-docs/policy-enforcement/sentinel#sentinel-imports
...
[import-tfconfig-variables-default]: /cloud-docs/policy-enforcement/sentinel/import/tfconfig#value-default

[import-tfconfig-variables]: /cloud-docs/policy-enforcement/sentinel/import/tfconfig#namespace-variables
...
~> When [resource targeting](/cli/commands/plan#resource-targeting) is in effect, `tfplan.resources` will only include the resources specified as targets for the run. This may lead to unexpected outcomes if a policy expects a resource to be present in the plan. To prohibit targeted runs altogether, ensure [`tfrun.target_addrs`](/cloud-docs/policy-enforcement/sentinel/import/tfrun#value-target_addrs) is undefined or empty.
