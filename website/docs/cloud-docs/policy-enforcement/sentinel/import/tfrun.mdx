...
required, using [policy sets](/cloud-docs/policy-enforcement/manage-policy-sets)
...
Specifies whether the plan associated with the run is a [speculative plan](/cloud-docs/run/remote-operations#speculative-plans) only.
