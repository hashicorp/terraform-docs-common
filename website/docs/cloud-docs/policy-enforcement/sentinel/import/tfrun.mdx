...
The **organization namespace** contains data associated with the current run's Terraform Cloud [organization](/terraform/cloud-docs/users-teams-organizations/organizations).
...
Details regarding each attribute can be found in the documentation for the Terraform Cloud [Workspaces API](/terraform/cloud-docs/api-docs/workspaces).
