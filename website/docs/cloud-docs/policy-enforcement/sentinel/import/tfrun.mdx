---
page_title: tfrun Sentinel import
description: Use the tfrun import to provide access to data associated with a Terraform run in Sentinel.
---

# tfrun Sentinel import
