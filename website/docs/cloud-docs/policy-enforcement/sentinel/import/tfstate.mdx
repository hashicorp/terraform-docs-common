...
[`applied`](/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-applied) collection in `tfplan` more useful,
...
-> **NOTE:** This value is also available via the [`tfplan`](/cloud-docs/policy-enforcement/sentinel/import/tfplan)
...
[import-tfplan-terraform-version]: /cloud-docs/policy-enforcement/sentinel/import/tfplan#value-terraform_version
