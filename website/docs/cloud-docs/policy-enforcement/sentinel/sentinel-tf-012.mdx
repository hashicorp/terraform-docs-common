...
([`tfconfig`](/cloud-docs/policy-enforcement/sentinel/import/tfconfig),
[`tfplan`](/cloud-docs/policy-enforcement/sentinel/import/tfplan), and
[`tfstate`](/cloud-docs/policy-enforcement/sentinel/import/tfstate)) have been updated to
...
There are no explicit changes in the [`tfrun`](/cloud-docs/policy-enforcement/sentinel/import/tfrun) import for
Terraform 0.12, but the
[`cost_estimate` namespace](/cloud-docs/policy-enforcement/sentinel/import/tfrun#namespace-cost_estimate)
...
[`tfconfig`](/cloud-docs/policy-enforcement/sentinel/import/tfconfig) import has seen the
...
For more information, see [`references` in the `tfconfig` import](/cloud-docs/policy-enforcement/sentinel/import/tfconfig#references-with-terraform-0-12).
...
[`tfplan`](/cloud-docs/policy-enforcement/sentinel/import/tfplan) import generally behaves
the same way with Terraform 0.12 as it does with Terraform 0.11 with the
following exceptions:

1. The behavior of unknown values within the
   [`applied`](/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-applied) value when creating or changing resources.
...
[resource namespace](/cloud-docs/policy-enforcement/sentinel/import/tfplan#namespace-resources-data-sources)
...
check the
[`computed`](/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-computed) key
within the [diff
namespace](/cloud-docs/policy-enforcement/sentinel/import/tfplan#namespace-resource-diff)
...
[`diff`](/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-diff) value in the `tfplan` import is empty.
...
New [`destroy`](/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-destroy) and
[`requires_new`](/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-requires_new) values have been added
...
The [`tfstate`](/cloud-docs/policy-enforcement/sentinel/import/tfstate) import has had
...
The [output
namespace](/cloud-docs/policy-enforcement/sentinel/import/tfstate#namespace-outputs) is
no longer available within `tfstate`'s [module
namespace](/cloud-docs/policy-enforcement/sentinel/import/tfstate#namespace-module). The
...
generation](/cloud-docs/policy-enforcement/sentinel/mock) has also been updated to
...
1. Follow the instructions to [generate mock data using the
   UI](/cloud-docs/policy-enforcement/sentinel/mock#generating-mock-data-using-the-ui)
...
data](/cloud-docs/policy-enforcement/sentinel/mock#using-mock-data) section of our
[mocking guide](/cloud-docs/policy-enforcement/sentinel/mock), the following layout will
