...
([`tfconfig`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfconfig),
[`tfplan`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan), and
[`tfstate`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfstate)) have been updated to
...
There are no explicit changes in the [`tfrun`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfrun) import for
Terraform 0.12, but the
[`cost_estimate` namespace](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfrun#namespace-cost_estimate)
...
[`tfconfig`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfconfig) import has seen the
...
For more information, see [`references` in the `tfconfig` import](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfconfig#references-with-terraform-0-12).
...
[`tfplan`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan) import generally behaves
the same way with Terraform 0.12 as it does with Terraform 0.11 with the
following exceptions:

1. The behavior of unknown values within the
   [`applied`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-applied) value when creating or changing resources.
...
[resource namespace](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan#namespace-resources-data-sources)
...
check the
[`computed`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-computed) key
within the [diff
namespace](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan#namespace-resource-diff)
...
[`diff`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-diff) value in the `tfplan` import is empty.
...
New [`destroy`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-destroy) and
[`requires_new`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfplan#value-requires_new) values have been added
...
The [`tfstate`](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfstate) import has had
...
The [output
namespace](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfstate#namespace-outputs) is
no longer available within `tfstate`'s [module
namespace](/terraform/cloud-docs/policy-enforcement/sentinel/import/tfstate#namespace-module). The
...
generation](/terraform/cloud-docs/policy-enforcement/sentinel/mock) has also been updated to
...
1. Follow the instructions on [configuring the Terraform version of the
   workspace](/terraform/cloud-docs/workspaces/settings#terraform-version) and
   ensure that it set to the latest 0.11 release.
1. [Start a run](/terraform/cloud-docs/run/ui#manually-starting-runs) for the workspace
   and let it finish the plan phase.
1. Follow the instructions to [generate mock data using the
   UI](/terraform/cloud-docs/policy-enforcement/sentinel/mock#generating-mock-data-using-the-ui)
...
1. [Discard the plan](/terraform/cloud-docs/run/ui#confirming-or-discarding-plans).
...
data](/terraform/cloud-docs/policy-enforcement/sentinel/mock#using-mock-data) section of our
[mocking guide](/terraform/cloud-docs/policy-enforcement/sentinel/mock), the following layout will
