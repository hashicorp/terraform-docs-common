...
1. Choose **Settings** in the sidebar, then **Policies** in your organization’s settings. A list of managed policies in HCP Terraform appears. Each policy designates its policy framework (Sentinel or OPA) and associated policy sets.
...
1. Choose **Settings** in the sidebar, then **Policies** in your organization’s settings. 
