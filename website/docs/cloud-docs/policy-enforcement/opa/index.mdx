...
Each [Terraform run](/docs/glossary#run) outputs data describing the run settings and the associated workspace. You can create mock JSON run data to [test OPA policies](#testing-policies).
