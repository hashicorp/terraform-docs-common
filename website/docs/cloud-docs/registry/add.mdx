...
You can add providers and modules through the UI as detailed below or through the [Registry Providers API](/cloud-docs/api-docs/private-registry/providers) and the [Registry Modules API](/cloud-docs/api-docs/private-registry/modules#create-a-module-with-no-vcs-connection-).
