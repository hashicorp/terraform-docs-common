...
Create a file named `key.json` with the following contents. Replace `ORG_NAME` with the name of your organization and supply your public key(RSA/DSA format) in the `ascii-armor` field.
