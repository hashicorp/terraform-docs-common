...
1. Choose **Registry** in the sidebar to navigate to your organization’s private registry, then find the module you want to deprecate a version of.
...
1. Sign in to [HCP Terraform](https://app.terraform.io/) or Terraform Enterprise and navigate to your organization.
1. Choose **Registry** in the sidebar to navigate to your organization’s private registry, then find the deprecated module version you want to revert the deprecation of.
1. Open the **Manage module for organization** dropdown.  
