...
You can generate tests for your module, and can run the resulting tests with [the `terraform test` command](/terraform/cli/commands/test).
...
You must have [permission to manage registry modules](/terraform/cloud-docs/users-teams-organizations/permissions#manage-private-registry) and [permission to manage module test generation](/terraform/cloud-docs/users-teams-organizations/permissions#manage-module-test-generation-beta) in order to generate tests.
