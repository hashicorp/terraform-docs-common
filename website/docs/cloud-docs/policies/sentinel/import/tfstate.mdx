...
[`applied`](/cloud-docs/policies/sentinel/import/tfplan#value-applied) collection in `tfplan` more useful,
...
-> **NOTE:** This value is also available via the [`tfplan`](/cloud-docs/policies/sentinel/import/tfplan)
...
[import-tfplan-terraform-version]: /cloud-docs/policies/sentinel/import/tfplan#value-terraform_version
