...
- [tfplan](/cloud-docs/policies/sentinel/import/tfplan) - This provides access to a Terraform plan, the file
...
- [tfconfig](/cloud-docs/policies/sentinel/import/tfconfig) - This provides access to a Terraform
  configuration, the set of "tf" files that are used to describe the desired
  infrastructure state.
- [tfstate](/cloud-docs/policies/sentinel/import/tfstate) - This provides access to the Terraform state, the
  file used by Terraform to map real world resources to your configuration.
- [tfrun](/cloud-docs/policies/sentinel/import/tfrun) - This provides access to data associated with a run
...
[Mocking Terraform Sentinel Data](/cloud-docs/policies/sentinel/mock).
...
[computed](/cloud-docs/policies/sentinel/import/tfplan#value-computed) and does
