...
[import-tfconfig]: /cloud-docs/policies/sentinel/import/tfconfig

[import-tfstate]: /cloud-docs/policies/sentinel/import/tfstate
...
[iterate-over-modules]: /cloud-docs/policies/sentinel/import/#iterate-over-modules-and-find-resources
...
[import-tfconfig-variables-default]: /cloud-docs/policies/sentinel/import/tfconfig#value-default

[import-tfconfig-variables]: /cloud-docs/policies/sentinel/import/tfconfig#namespace-variables
...
~> When [resource targeting](/cli/commands/plan#resource-targeting) is in effect, `tfplan.resources` will only include the resources specified as targets for the run. This may lead to unexpected outcomes if a policy expects a resource to be present in the plan. To prohibit targeted runs altogether, ensure [`tfrun.target_addrs`](/cloud-docs/policies/sentinel/import/tfrun#value-target_addrs) is undefined or empty.
