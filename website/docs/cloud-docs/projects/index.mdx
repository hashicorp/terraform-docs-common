...
The projects table displays the project's metadata, including its name,
description, and the number of teams and workspaces that belong to it. You can
sort projects by name by clicking the blue arrow icon beside the **Project
name** table header. To view your organization's projects, click **Projects**.
You can sort the projects by clicking on the blue arrows beside the “Project
name” table header. The table displays project’s metadata including name,
description, and the count of teams and workspaces that belong to the project.
