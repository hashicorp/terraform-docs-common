...
1. Add a description for the project. This field is optional.
    ...
    ~> **Adding project tags is in limited beta and unavailable for some users.** Skip to step 8 if your interface does not include elements for adding tags. Contact your HashiCorp representative for information about participating in the limited beta.  
