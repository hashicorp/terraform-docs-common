...
1. Open the **Add key value tags** menu to add tags to your project. Tags are optional key-value pairs that you can use to organize projects. Workspaces created within the project inherit project tags. Refer to [Define tags](#define-tags) for additional information.
