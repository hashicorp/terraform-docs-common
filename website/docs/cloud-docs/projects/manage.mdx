...
1. Add a description for the project. This field is optional.
    ...
    ~> **Adding project tags is in private beta and unavailable for some users.** Skip to step 8 if your interface does not include elements for adding tags. Contact your HashiCorp representative for information about participating in the limited beta.  
...
~> **Adding project tags is in limited beta and unavailable for some users.** Contact your HashiCorp representative for information about participating in the limited beta.  
...
Workspace administrators with appropriate permissions can attach new key-value pairs to their workspaces to override inherited tags. Refer to [Workspace tags](/terraform/cloud-docs/workspaces/create#define-workspace-tags) for additional information about using tags in workspaces.
