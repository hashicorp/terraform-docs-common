...
1. Sign in to [HCP Terraform](https://app.terraform.io/) or Terraform Enterprise and click **Projects**.
...
1. Choose **Settings** from the sidebar. The settings view for the selected project appears.
