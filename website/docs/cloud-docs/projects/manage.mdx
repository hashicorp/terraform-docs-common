...
Whether to use HCP Terraform as the Terraform execution platform for this project.

By default, a project will honor the organization default, however it can override it. Any newly created workspaces in a project will inherit the project default.
