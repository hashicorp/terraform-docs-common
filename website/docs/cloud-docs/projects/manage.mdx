...
1. Open the **Add key value tags** menu to add tags to your project. Tags are optional key-value pairs that you can use to organize projects. Workspaces created within the project inherit project tags. Refer to [Define project tags](#define-project-tags) for additional information.
...
1. You can  **+add another tag** to attach any additional tags.
...
- Tabs can include letters, numbers, colons, hyphens, and underscores.
