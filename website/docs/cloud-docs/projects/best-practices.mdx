...
- **Variable set usage**: Project-wide variable sets let you configure and reuse values such as default tags for cost-codes, owners, and support contacts. Variable sets can be owned by the projects to separate management and access between projects.
