...
1. Click on a project name to view more details.
...
Terraform Cloud will return a new project page displaying all the project
information.
...
Terraform Cloud will return to the **Projects** view with the deleted project
