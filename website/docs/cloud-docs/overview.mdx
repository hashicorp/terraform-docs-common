...
You can use projects to organize your workspaces into groups. Organizations with the [Team & Governance](https://www.hashicorp.com/products/terraform/pricing) tier can assign teams permissions for specific projects. 
