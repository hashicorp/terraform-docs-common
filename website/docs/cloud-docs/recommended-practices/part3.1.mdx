...
tfc_only: true
description: >-
  Move from mostly manual to semi-automation workflows. Install Terraform, write configuration, follow the get started tutorials, and deploy real infrastructure in this guide.
---
...
If your current provisioning practices are largely manual, your first goal is to begin using the Terraform CLI in a small, manageable subset of your infrastructure. Once you’ve gotten some small success using Terraform, you’ll have reached the semi-automated stage of provisioning maturity, and can begin to scale up and expand your Terraform usage.
