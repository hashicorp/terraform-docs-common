...
tfc_only: true
description: >-
  Considerations for improving your collaborative infrastructure-as-code workflows. Move more infrastructure to Terraform Cloud, adopt Packer, enforce compliance with Sentinel policies, use audit logs, add monitoring and performance metrics, and use the Terraform Cloud API.
---
...
* Use the Terraform Cloud API. The [Terraform Cloud API](/terraform/cloud-docs/api-docs) can be used to integrate with general-purpose CI/CD tools to trigger Terraform runs in response to a variety of events.
