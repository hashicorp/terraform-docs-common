...
tfc_only: true
description: >-
  Considerations for improving your collaborative infrastructure-as-code workflows. Move more infrastructure to HCP Terraform, adopt Packer, enforce compliance with Sentinel policies, use audit logs, add monitoring and performance metrics, and use the HCP Terraform API.
---
