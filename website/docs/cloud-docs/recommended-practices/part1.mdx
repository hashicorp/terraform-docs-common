...
In Terraform Community edition, a workspace is an independent state file on the local disk. In Terraform Cloud, they're persistent shared resources; you can assign them their own access controls, monitor their run states, and more.
