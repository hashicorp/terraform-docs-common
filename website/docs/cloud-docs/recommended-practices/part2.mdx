...
tfc_only: true
description: >-
  Part 2 of the Terraform Recommended Practices guide to help you assess which recommended practices you're currently using.
---
...
Now that you've taken a hard look at your current practices, it's time to begin improving them. Continue on to [Part 3: How to Evolve Your Provisioning Practices](/cloud-docs/recommended-practices/part3).
