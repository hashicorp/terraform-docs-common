...
tfc_only: true
description: >-
  Move from semi-automation to infrastructure-as-code workflows. Use version control, create a module, share knowledge, set guidelines, integrationw ith configuration management, and manage secrets in this guide.
---
...
Next, you need an advanced workflow that can scale and delegate responsibilities to many contributors. Continue on to [Part 3.3: How to Move from Infrastructure as Code to Collaborative Infrastructure as Code](/cloud-docs/recommended-practices/part3.3).
