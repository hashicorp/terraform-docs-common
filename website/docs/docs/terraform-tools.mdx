...
|[Terraform and HCL plugin](https://plugins.jetbrains.com/plugin/7808-terraform-and-hcl) | JetBrains | Enable syntax highlighting, auto-completion and other editing features.| [Develop Terraform configurations with Pycharm, Intellij IDEA JetBrains](https://plugins.jetbrains.com/plugin/7808-terraform-and-hcl) |
