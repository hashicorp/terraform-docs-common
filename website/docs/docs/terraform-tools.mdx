...
|Name | Maintainer |Description| Tutorial |
|-----|------------|-----------|----------|
| [Plugin SDK](/terraform/plugin/sdkv2) | HashiCorp | Develop your own Terraform providers. | [Setup and Implement Read](/terraform/tutorials/providers/provider-setup) |
