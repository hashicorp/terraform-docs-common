...
|[Plugin Framework](/plugin/framework) | HashiCorp | A new SDK to develop your own Terraform providers. The framework provides improvements and additional features beyond what is available in the Plugin SDK. | [Implement Create and Read with the Terraform Plugin Framework](/tutorials/providers-plugin-framework/providers-plugin-framework-resource-create) |
