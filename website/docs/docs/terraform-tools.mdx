...
|-----|------------|-----------|----------|
|[Cloud Development Kit for Terraform (CDKTF)](/terraform/cdktf)| HashiCorp | Use familiar programming languages to define and provision infrastructure. CDKTF currently supports TypeScript, Python, Java, C#, and Go. | [Write CDK for Terraform configurations](/terraform/tutorials/cdktf) |
