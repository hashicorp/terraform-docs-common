...
- [Terraform Cloud docs: About Runs](/cloud-docs/run/remote-operations)
...
- [Terraform docs: Expressions — Indices and Attributes](/language/expressions#indices-and-attributes)
...
- [Terraform docs: Backends](/language/settings/backends/configuration)
...
- [Terraform docs: Resources](/language/resources)
...
- [Terraform docs: Expressions](/language/expressions)
...
- [Terraform docs: Expressions - String Templates](/language/expressions#string-templates)
...
- [Terraform Cloud docs: Managing Sentinel Policies](/cloud-docs/policy-enforcement/manage-policy-sets)
...
- [Terraform Cloud Docs: Terraform Runs and Remote Operations](/cloud-docs/run/remote-operations#remote-operations)
...
- [Terraform Enterprise docs: SAML Single Sign-On](/enterprise/saml/configuration)
...
- [Terraform Cloud docs: Sentinel](/cloud-docs/policy-enforcement)
