...
- [Terraform Cloud docs: API](/terraform/cloud-docs/api-docs)
...
- [Terraform docs: The `terraform apply` command](/terraform/cli/commands/apply)
- [Terraform Cloud docs: About Runs](/terraform/cloud-docs/run/remote-operations)
...
We often use "Terraform CLI" to refer to the core Terraform Community edition binary when we need to distinguish it from other parts of the Terraform ecosystem (like Terraform Cloud or the Terraform GitHub Actions).
...
- [Terraform Cloud docs: Run States and Stages](/terraform/cloud-docs/run/states)
...
- [Terraform Cloud docs: VCS Integration](/terraform/cloud-docs/vcs)
...
- [Terraform Cloud docs: VCS Integration](/terraform/cloud-docs/vcs)
- [Terraform Cloud API docs: OAuth Clients](/terraform/cloud-docs/api-docs/oauth-clients)
...
- [Terraform Cloud docs: VCS Integration](/terraform/cloud-docs/vcs)
- [Terraform Cloud API docs: OAuth Tokens](/terraform/cloud-docs/api-docs/oauth-tokens)
...
- [Terraform Cloud docs: Organizations](/terraform/cloud-docs/users-teams-organizations/organizations)
...
Terraform and all other HashiCorp products are accessible through a source-available license that allows broad copying, modification, and redistribution. Terraform Cloud and Terraform Enterprise are closed-source commercial software, that make use of Terraform and the available Terraform providers.
...
- [Terraform Cloud docs: Permissions](/terraform/cloud-docs/users-teams-organizations/permissions)
...
- [Terraform Cloud docs: Managing Sentinel Policies](/terraform/cloud-docs/policy-enforcement/manage-policy-sets)
...
- [Terraform Cloud docs: Private Registry](/terraform/cloud-docs/registry)
...
- [Terraform Cloud Docs: Terraform Runs and Remote Operations](/terraform/cloud-docs/run/remote-operations#remote-operations)

## Remote Backend

[remote backend]: /terraform/docs/glossary#remote-backend

A Terraform CLI feature that lets Terraform connect to Terraform Cloud, by specifying in the Terraform [configuration][] which organization and workspace(s) to use. Used for [remote operations][] in Terraform Cloud workspaces, and used for [state][] storage in Terraform Cloud's free edition.
...
- [Terraform Cloud docs: Runs Triggers](/terraform/cloud-docs/workspaces/settings/run-triggers)
...
- [Terraform Cloud docs: Sentinel](/terraform/cloud-docs/policy-enforcement)
...
- [Terraform Cloud docs: SSH Keys for Cloning Modules](/terraform/cloud-docs/workspaces/settings/ssh-keys)
...
- [Terraform Cloud docs: Teams](/terraform/cloud-docs/users-teams-organizations/teams)
...
[terraform cloud]: /terraform/docs/glossary#terraform-cloud
...
- [Terraform Cloud docs](https://cloud.hashicorp.com/products/terraform)
...
[tfe provider]: /terraform/docs/glossary#tfe-provider-terraform-cloud-provider
...
- [Terraform Cloud docs: User Tokens](/terraform/cloud-docs/users-teams-organizations/users#api-tokens)
- [Terraform Cloud docs: Team Tokens](/terraform/cloud-docs/users-teams-organizations/teams#api-tokens)
- [Terraform Cloud docs: Organization Tokens](/terraform/cloud-docs/users-teams-organizations/organizations#api-tokens)
...
- [Terraform Cloud docs: UI/VCS-based Run Workflow](/terraform/cloud-docs/run/ui)
...
- [Terraform Cloud docs: Variables](/terraform/cloud-docs/workspaces/variables)
...
A specific service that provides [VCS][] features, with the goal of enabling teams to collaborate on code. Terraform Cloud can integrate with VCS providers to access your Terraform [configurations][] and [modules][], and currently supports GitHub, GitHub Enterprise, GitLab.com, GitLab EE and CE, Bitbucket Cloud, Bitbucket Data Center, Azure DevOps Server, and Azure DevOps Services.

- [Terraform Cloud docs: Connecting VCS Providers](/terraform/cloud-docs/vcs)
...
- Terraform Cloud creates webhook configurations on [VCS providers][], so that they send webhook requests to Terraform Cloud whenever linked [repositories][] receive [pull requests][] or new [commits][]. ([Terraform Cloud docs: UI/VCS-driven Runs](/terraform/cloud-docs/run/ui))
- Users can create webhook configurations on Terraform Cloud [workspaces][], so that Terraform Cloud will send run notification webhooks to Slack or other external services. ([Terraform Cloud docs: Run Notifications](/terraform/cloud-docs/workspaces/settings/notifications))
...
- [Terraform Cloud docs: Workspaces](/terraform/cloud-docs/workspaces)
