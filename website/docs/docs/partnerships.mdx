...
a) Write your own custom provider with our [tutorial](/terraform/tutorials/providers-plugin-framework).
...
d) An overview of the new Plugin Framework and improvements to the Terraform Provider ecosystem:
