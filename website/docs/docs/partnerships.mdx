...
a) Writing custom providers [guide](/terraform/plugin/framework)

b) Creating a Terraform Provider with the Plugin Framework: [video](https://www.youtube.com/watch?v=16qs7LJSyps)

c) An overview of the new Plugin Framework and improvements to the Terraform Provider ecosystem: [video](https://www.youtube.com/watch?v=pAeQC0fC3Xw)

d) Example provider for reference: [HTTP](https://github.com/hashicorp/terraform-provider-http)
