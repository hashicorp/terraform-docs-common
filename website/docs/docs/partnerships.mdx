...
a) Writing custom providers [tutorial](/terraform/tutorials/providers-plugin-framework)

b)  Get started with the Plugin Framework [repository] and the writing custom providers [guide](/terraform/plugin/framework).
