...
Anyone interested in publishing can create an account and sign in to the Terraform Registry using a GitHub account. Click the **Sign-in** button, and follow the login prompts. Once you have authorized the use of your GitHub account and are signed in, you can publish any resource types from a GitHub repository.  Refer to the specific instructions for [modules](/registry/modules/publish), [providers](/registry/providers/publishing), and [policy libraries](/registry/policy-libraries/publishing).
