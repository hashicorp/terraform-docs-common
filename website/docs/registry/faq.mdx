...
We make every effort to support GitHub Markdown syntax in the registry documentation, but there may be instances where compatibility limitations arise. To ensure consistent rendering in the Public Registry, we recommend using syntax widely supported across various Markdown flavors. You can test out your documentation in the registry docs preview tool at https://registry.terraform.io/tools/doc-preview.
