...
## Can I change the name of my integration?
...
## Can I rename the GitHub user or organization that owns my integration's repository?

When you change the name of a GitHub user or organization, GitHub automatically redirects requests for the old user or organization to the new one. This means there is no interruption for your integration's consumers, who can continue using the old name. If you need to change the name of your integration, [see the above answer](#can-i-change-the-name-of-my-integration).
...
If a new version you've published to GitHub is not showing up in the Terraform Registry, [try resyncing your integration with Github](#what-does-resyncing-an-integration-do).
...
## How is the latest version of an integration selected?
...
No. The Terraform Registry's version sorting is strictly SemVer compliant ([see above](#how-is-the-latest-version-of-an-integration-selected)). This means that "latest" in the Registry can be a prerelease version, if the prerelease's version identifier has the greatest precedence.
...
## Can I regain ownership of my integration after losing access to my GitHub account?
