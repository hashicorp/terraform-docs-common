...
We make every effort to support GitHub Markdown syntax, but there are some limitations. To ensure consistent rendering across platforms, we recommend using generic Markdown syntax whenever possible.
