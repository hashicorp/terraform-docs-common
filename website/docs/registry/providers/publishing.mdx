---
page_title: Publish providers in the Terraform Registry
description: Learn how to create, document, release, and publish a provider in the Terraform Registry.
---
