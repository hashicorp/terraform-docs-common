...
Our Provider Development Program sets the standards for publishing providers and modules and marks approved providers and modules with a `Partner` badge. Refer to the [Program Details](/docs/partnerships) for details about how to join and program requirements.
