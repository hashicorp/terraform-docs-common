...
You can also use modules marked **No-Code Ready** to create a new workspace and automatically provision the module's resources without writing any Terraform configuration. Refer to [Preparing No-Code Ready Modules](https://www.terraform.io/cloud-docs/no-code-provisioning/module-design) for details.
