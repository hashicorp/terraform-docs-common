...
By default, only [verified modules](/terraform/registry/modules/verified)
...
[Terraform Cloud's private registry is documented here.](/terraform/cloud-docs/registry)
